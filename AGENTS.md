...
3. **File Management:** 
   - Store all temporary markdown files, buildtime logs, temporary test and verification scripts in the `local_only/scratch` directory of the workspace (use `docs/scratch ` when using github codespaces).
