...
NODE_FORMATTER_EXCLUSIONS: Dict[str, List[str]] = {
    ...
    'mat_g1_na_q4_3': ['number_line_read', 'peso_money_build'],
    'mat_g1_na_q4_5': ['number_line_read', 'peso_money_build'],
    'mat_g1_na_q4_6': ['peso_money_build'],
    ...
    'mat_g2_na_q2_1': ['number_line_read', 'peso_money_build'],
    'mat_g2_na_q2_2': ['emoji_pictorial', 'number_bond', 'number_line_set', 'peso_money_build'],
    ...
    'mat_g2_na_q3_0': ['number_line_read'],
    'mat_g2_na_q3_2': ['emoji_pictorial', 'number_line_read'],
    'mat_g2_na_q3_3': ['array_grid_read', 'array_grid_set', 'emoji_pictorial', 'number_line_read'],
    ...
    'mat_g3_mg_q2_0': ['cloze', 'mcq'],
    'mat_g3_mg_q2_1': ['scale_read'],
    'mat_g3_mg_q2_2': ['ordering', 'scale_read', 'sort_order', 'true_false'],
    'mat_g3_mg_q2_3': ['cloze', 'mcq'],
    'mat_g3_mg_q2_4': ['scale_read'],
    'mat_g3_mg_q2_5': ['ordering', 'scale_read', 'sort_order', 'true_false'],
    ...
    'mat_g3_na_q2_0': ['number_line_read', 'peso_money_build'],
    ...
    'mat_g3_na_q3_0': ['emoji_pictorial', 'number_line_read'],
    'mat_g3_na_q3_1': ['array_grid_read', 'array_grid_set', 'emoji_pictorial', 'number_line_read'],
    'mat_g3_na_q3_2': ['array_grid_read', 'array_grid_set', 'emoji_pictorial', 'number_line_read'],
    'mat_g3_na_q3_3': ['array_grid_read', 'array_grid_set', 'emoji_pictorial', 'number_line_read'],
    'mat_g3_na_q3_4': ['array_grid_read', 'array_grid_set', 'emoji_pictorial', 'number_line_read'],
