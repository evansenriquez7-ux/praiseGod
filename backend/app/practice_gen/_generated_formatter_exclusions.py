...
NODE_FORMATTER_EXCLUSIONS: Dict[str, List[str]] = {
    ...
    "mat_g1_na_q1_9": ['cloze', 'emoji_pictorial', 'error_detect', 'number_bond', 'number_line_read', 'number_line_set', 'true_false'],
    ...
    "mat_g1_na_q2_6": ['cloze', 'emoji_pictorial', 'error_detect', 'number_bond', 'number_line_read', 'number_line_set', 'true_false'],
    ...
    "mat_g2_na_q3_1": ['array_grid_read', 'array_grid_set', 'cloze', 'error_detect', 'true_false'],
    ...
    "mat_g3_na_q3_4": ['array_grid_read', 'array_grid_set', 'cloze', 'error_detect', 'true_false'],
