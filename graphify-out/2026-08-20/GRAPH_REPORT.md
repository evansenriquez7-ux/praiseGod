...
## Corpus Check
- 452 files · ~727,569 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3414 nodes · 5427 edges · 275 communities (259 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 89 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d66a0306`
...
- [[_COMMUNITY_get_matatag_lab_config|get_matatag_lab_config]]
- [[_COMMUNITY_Native SQL Examples|Native SQL Examples]]
- [[_COMMUNITY__get_available_formats|_get_available_formats]]
...
5. `Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02` - 42 edges
...
## Communities (275 total, 16 thin omitted)
...
Cohesion: 0.10
Nodes (27): get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, _bound_restricts_to(), _content_words(), _provided_for_node(), Any, Practice Generation — Capability Contract Validator (§6)  The problem this solve, Lowercased alphanumeric tokens of `text`, minus function words. (+19 more)
...
Cohesion: 0.12
Nodes (22): decompose_to_places(), "N is H hundreds, T tens, and O ones." (place values whose digit is 0     are om, _build_equation_sentence(), format_cloze(), Random, Build pure equation with blank based on concept and blank_target., Format a QuestionContext as a cloze (fill-in-the-blank) problem.      Respects t, _build_pure_equation() (+14 more)
...
Cohesion: 0.11
Nodes (18): 1. Fractions answer-key false positive — `mat_g2_na_q4_0`/`_1`/`_2`, 2026-08-13 — length_measurement: the largest FAIL cluster in the tree, 2026-08-13 — The unanswerable measure item was a routing bug, not a wording one, 2026-08-19 — Unit 3 completion + full `run_all` verification, 2. `§1A-reach` false failure — `mat_g3_na_q2_0` (money_peso), 3. KG monotonicity — `order_of_operations` introduced but not propagated, Final Definition of Done, Full `run_all` — the intended red, with no machine-stage regression (+10 more)
...
Cohesion: 0.17
Nodes (11): get_node_dnas(), get_node_formatters(), Return the list of DNA concept names for a node.      Args:         node_id: MAT, Return the union of compatible formatters from all DNAs for a node.      Looks u, PracticeOrchestrator, Any, Bridge Layer separating the generation logic from the FastAPI routing/server lay, The orchestrator must set problem.dna_name to the actually-chosen DNA. (+3 more)
...
Cohesion: 0.21
Nodes (11): _distractor_fallback.py — Distractor Augmentation Helper  Per AGENTS.md rule #4:, Textual Formatter — Cloze (Fill-in-the-Blank)  Unified formatter for fill-in-the, _build_balance_params(), _build_traps(), format_balance_scale(), Random, fmt_balance_scale.py — BalanceScale visual formatter  NEW formatter — no existin, Return up to 3 distractor values.      Traps:         wrong_op     — adds instea (+3 more)
...
Cohesion: 0.14
Nodes (10): get_dnas_for_formatter(), get_supported_variants(), is_compatible(), Any, Practice Generation — DNA-Formatter Compatibility Table ========================, Return variants supported by a specific DNA + formatter combination.      Applie, Validate a lab UI selection and return compatibility info.      Args:         dn, Return True if the formatter is compatible with the given DNA concept.      Args (+2 more)
...
Cohesion: 0.29
Nodes (11): capability_findings(), _cputime_to_seconds(), _etime_to_seconds(), ledger_state(), main(), Cheap, seconds: how many capability problems the contract reports right now., ps elapsed time: [[dd-]hh:]mm:ss, Return (healthy, hung) watched processes, judged by CPU-to-elapsed ratio. (+3 more)

### Community 215 - "mastery_drill.py"
Cohesion: 0.18
Nodes (17): _apply(), _first_failure_line(), main(), Mutation, _plant_template_rationale(), _plant_wildcard_provider(), Path, Mutation harness — verify the verifier (pgen_hardening.md Phase 4).  The validat (+9 more)
...
### Community 249 - "get_matatag_lab_config"
Cohesion: 0.31
...
### Community 250 - "Native SQL Examples"
Cohesion: 0.25
...
Cohesion: 0.11
Nodes (26): Any, Registry to map visual types to their Pydantic schemas., VisualSchemaRegistry, _parse_contract_section_refs(), Practice Generation — Validation Harness Runner  Runs all validators in the prac, Extract every '§1A'-style reference from docs/pgen_contract.md's rule     table, run_all(), count_addition_carries() (+18 more)
...
### Community 260 - "mastery_drill.py"
Cohesion: 0.33
...
### Community 261 - "Part 3 — Concrete restructuring of the current docs/"
Cohesion: 0.33
...
### Community 263 - "get_pipeline_status"
Cohesion: 0.40
...
### Community 267 - "2026-08-14 — "2-digit by 1-digit" bounds two operands, and only one had a key"
Cohesion: 0.50
...
## Knowledge Gaps
- **1069 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+1064 more)
...
- **Why does `FormattedProblem` connect `Community 131` to `generate_params`, `mastery_drill.py`, `Community 8`, `Community 13`, `Community 18`, `Community 153`, `Community 25`, `Community 50`, `Community 51`, `Spine`, `validate_interest.py`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `validate_capability.py`, `get_gemini_models`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `test_semantic_leak_guards.py`, `run_audit`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 99`, `Community 100`, `CompetencyConfiguration`, `generate_params`, `fmt_ruler_measure.py`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `DNA` connect `validate_interest.py` to `get_all_node_ids`, `socratic_chat_exchange`, `generate_params`, `Community 101`, `TestLogScaleDeclarations`, `Community 41`, `Community 138`, `Community 14`, `Community 118`, `Native SQL Examples`, `Community 123`, `mass_capacity.py`, `fractions.py`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `generate_params`, `Community 131`, `Community 13`, `Community 18`, `Community 153`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `get_gemini_models`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `run_audit`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `get_all_node_ids`, `Community 99`, `Community 100`, `CompetencyConfiguration`, `generate_params`, `fmt_ruler_measure.py`, `Community 123`?**
