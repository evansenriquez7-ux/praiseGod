...
## Corpus Check
- 459 files · ~745,044 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3479 nodes · 5511 edges · 275 communities (258 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9866fe33`
...
Cohesion: 0.11
Nodes (22): decompose_to_places(), generate_hints(), generate_params(), Any, DNA: Addition (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (ar, "N is H hundreds, T tens, and O ones." (place values whose digit is 0     are om, Generate (a, b) that satisfy the difficulty_profile constraints.      Uses smart, # NOTE: "structure" is a contextual variant, not a difficulty dimension. (+14 more)
...
Cohesion: 0.07
Nodes (34): CompetencyConfiguration, _get_available_formats(), get_intro_status(), get_matatag_difficulty_axes(), get_matatag_lab_interests(), get_matatag_nodes(), get_matatag_progress(), get_node_config() (+26 more)
...
- **Why does `FormattedProblem` connect `Community 41` to `generate_params`, `Community 4`, `Community 8`, `fmt_array_grid.py`, `Community 13`, `2026-08-13 — length_measurement: the largest FAIL cluster in the tree`, `2026-08-20 — §5 worker death: a silent unbounded wait in the last gate`, `Community 18`, `Community 153`, `Community 50`, `Community 51`, `Spine`, `validate_interest.py`, `Native SQL Examples`, `Community 59`, `Community 60`, `validate_capability.py`, `get_gemini_models`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 99`, `CompetencyConfiguration`, `Community 100`, `Community 102`, `Community 104`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `DNA` connect `validate_interest.py` to `Community 1`, `socratic_chat_exchange`, `generate_params`, `get_all_node_ids`, `Community 101`, `Community 36`, `TestLogScaleDeclarations`, `counting.py`, `get_interest_themes`, `generate_params`, `Community 14`, `Community 117`, `Community 118`, `Community 123`, `mass_capacity.py`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `get_node_info()` connect `Community 26` to `get_all_node_ids`, `Community 36`, `Community 4`, `Community 8`, `Community 11`, `Community 78`, `Community 86`, `hardening_supervisor.py`, `Community 94`, `fmt_numeric_input.py`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
