...
## Corpus Check
- 470 files · ~767,315 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3527 nodes · 5569 edges · 288 communities (265 shown, 23 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cfac500e`
...
Cohesion: 0.09
Nodes (39): apply_formatter(), generate_batch(), generate_problem(), _get_dna_instance(), Any, Random, Practice Generation — API Adapter ===================================  Main entr, Import the DNA module and return its DNA instance. (+31 more)
...
Cohesion: 0.10
Nodes (29): get_variants_for_dna(), Return all contextual variants defined for a DNA concept.      Args:         dna, _build_symbolic_question(), _detect_axes_served(), _eval_error_formula(), generate_context(), _import_dna_module(), Any (+21 more)
...
Cohesion: 0.05
Nodes (49): DimensionSpec, ErrorPattern, extract_continuous_scalar(), extract_discrete_level(), Practice Generation — DNA Base Definitions  All dataclasses, enums, and shared u, A pedagogically meaningful wrong answer.      formula:          SymPy expression, A mathematical term fragment gated behind vocab knowledge.      preferred:    Te, Extracts a discrete level from the difficulty profile.     If the value is a str (+41 more)
...
- **Why does `FormattedProblem` connect `models.py` to `generate_params`, `Community 4`, `_get_available_formats`, `.axis_level_index`, `generate_params`, `Community 8`, `fmt_array_grid.py`, `Community 13`, `Community 18`, `Community 153`, `Community 25`, `Community 41`, `Community 50`, `Community 51`, `Spine`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `socratic_chat_exchange`, `CompetencyConfiguration`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `generate_params`, `_get_available_formats`, `.axis_level_index`, `generate_params`, `Community 13`, `Community 18`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `models.py`, `Community 94`, `Community 95`, `get_all_node_ids`, `socratic_chat_exchange`, `CompetencyConfiguration`, `Community 117`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `DNA` connect `validate_interest.py` to `Community 1`, `generate_params`, `Community 11`, `Community 14`, `Community 24`, `Community 36`, `Community 41`, `mastery_drill.py`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `_get_available_formats`, `mass_capacity.py`, `models.py`, `get_all_node_ids`, `Community 101`, `RedisDict`, `Community 117`, `Community 118`, `Part 3 — Concrete restructuring of the current docs/`, `Community 123`?**
