...
## Corpus Check
- 754 files · ~1,510,046 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5134 nodes · 7858 edges · 403 communities (360 shown, 43 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 109 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d5c752d1`
...
## Communities (403 total, 43 thin omitted)
...
Cohesion: 0.12
Nodes (20): _build_all_enabled_config(), _combined_interests(), flag_question(), get_practice_question(), get_practice_question_batch(), Session, Build the (formatters, difficulties, contexts) triple mirroring the     Matatag, Background task to pre-generate questions into the cache.     Uses parallel exec (+12 more)

### Community 4 - "Community 4"
Cohesion: 0.10
Nodes (28): Translate a FormattedProblem to the legacy skeleton dict format.      This shim, to_legacy_dict(), get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, _audit_node(), build_test_profiles(), _check_cap_vs_formatter_code(), _check_variant_sensitivity() (+20 more)
...
Cohesion: 0.14
Nodes (19): applicability_failures(), count_addition_carries(), count_subtraction_borrows(), coverage_regressions(), expected_checks_for_node(), formatter_refused_at_node(), main(), validate_matrix.py  Executes the full behavioral matrix for every node in the MA (+11 more)
...
Cohesion: 0.08
Nodes (37): enumerate_profiles(), extract_numerical_limits(), get_dimension_ranges(), _make_predicates(), measure_acceptance_rate(), normalize_difficulty(), Any, Random (+29 more)

### Community 87 - "Community 87"
Cohesion: 0.17
Nodes (13): log_scale_value(), The integer a 0-1 position `t` maps to on a logarithmic axis [min_val, max_val]., generate_hints(), generate_params(), _make_expanded_form(), num_to_tagalog_style_english_words(), Any, Generate a number reading/writing problem.      Returns:         {             " (+5 more)
...
Cohesion: 0.05
Nodes (58): _boundary_distance(), generate_hints(), generate_params(), Any, Return 2–4 step-by-step hints for a rounding problem., Round n to the nearest precision (10, 100, 1000) using round-half-up., Return how far n is from the nearest rounding boundary., Generate a rounding problem (G3 only).      Returns:         {             "numb (+50 more)
...
Cohesion: 0.03
Nodes (103): get_dnas_for_formatter(), get_variant_curriculum_gate(), get_variants_for_dna(), is_compatible(), is_variant_available_at(), node_grade_quarter(), Practice Generation — DNA-Formatter Compatibility Table ========================, Return all contextual variants defined for a DNA concept.      Args:         dna (+95 more)
...
Cohesion: 0.04
Nodes (47): 1. Distractor Non-Determinism Fix in `place_value.py`, 1. Fractions answer-key false positive — `mat_g2_na_q4_0`/`_1`/`_2`, 2026-08-13 — length_measurement: the largest FAIL cluster in the tree, 2026-08-13 — Object-to-unit pairing: the numbers were right, the things were wrong, 2026-08-19 — Hardening Unit 3: mutation coverage for §5 and §6, 2026-08-19 — Unit 3 completion + full `run_all` verification, 2026-08-20 — §5 worker death: a silent unbounded wait in the last gate, 2026-08-20 (tick 7) — The harness now runs its own tests (+39 more)

### Community 104 - "Community 104"
Cohesion: 0.03
Nodes (81): DimensionSpec, DNA, ErrorPattern, extract_continuous_scalar(), extract_discrete_level(), Practice Generation — DNA Base Definitions  All dataclasses, enums, and shared u, A pedagogically meaningful wrong answer.      formula:          SymPy expression, A mathematical term fragment gated behind vocab knowledge.      preferred:    Te (+73 more)
...
Cohesion: 0.10
Nodes (30): _attestation_integrity(), _attestation_records(), _attestation_staleness(), _bound_restricts_to(), _load_attestations(), _phase2_findings(), Any, Every attestation batch on disk, whole, for the freshness pass. (+22 more)
...
Cohesion: 0.04
Nodes (83): get_all_node_ids(), get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, _bound_allows(), build_group(), build_packet(), _main() (+75 more)
...
Cohesion: 0.10
Nodes (26): option_rng(), Any, Random, Where the correct option sits must not be predictable.  Why this exists --------, A shuffle stream unique to this (node, seed), stable across processes., Shuffle in place using a (node, seed)-keyed stream, and return the list.      Ca, shuffle_options(), _build_equation_sentence() (+18 more)
...
Cohesion: 0.23
Nodes (5): formatter_supports_profile(), Mirror the orchestrator's per-DNA×formatter compatibility check     (backend/app, test_formatter_supports_profile.py =================================== Regressio, formatter_supports_profile must reject formatters not in the     DNA's compatibl, TestFormatterSupportsProfileGate1
...
Cohesion: 0.25
Nodes (11): _are_values_equal(), _eval_formula(), Any, Validate a formula-type DNA for structural correctness.      Checks:       1. an, Validate an algorithmic-type DNA for structural correctness.     Similar to vali, Call the DNA module's generate_params with a neutral profile.     Returns the pa, Evaluate a formula string with values as variable bindings., Check if two math values are equal, supporting fraction strings vs float compari (+3 more)
...
Cohesion: 0.05
Nodes (79): apply_experience(), apply_formatter(), generate_batch(), generate_problem(), _get_dna_instance(), Any, Random, Practice Generation — API Adapter ===================================  Main entr (+71 more)
...
Cohesion: 0.13
Nodes (22): CompetencyConfiguration, collect_findings(), main(), §10 — the grading contract: a correct answer must be graded correct, by every gr, Every (node, seed) where a known-correct answer is not graded correct by all thr, validate_all(), LabV2ConfigSaveRequest, LabV2GenerateRequest (+14 more)
...
Cohesion: 0.11
Nodes (19): Generate a single practice problem and return it as a dict.      This is the sin, run(), matatag_lab_v2_generate(), Generate a practice problem using the new practice_gen pipeline., build(), main(), Any, Attester packets — the blind evidence a CAPABILITY_PROVIDERS entry has to surviv (+11 more)
...
Cohesion: 0.17
Nodes (13): get_variant_combinations(), Any, §1G — arithmetic and structural sanity of the rendered visual payload.      Ever, §1F's second, independent path: the stem says the answer in words.      The orig, Score the complexity of whole numbers/fractions in problem.given_values., Generate all possible variant assignment combinations from supported variants di, run_matrix_for_node(), score_problem_operands() (+5 more)
...
Cohesion: 0.25
Nodes (10): count_noun(), The count noun to write after `count`. Singular when the count is exactly 1., decompose_to_places(), "N is H hundreds, T tens, and O ones." (place values whose digit is 0     are om, _answer_shape(), format_true_false(), Random, Textual Formatter — True / False  Presents a declarative statement like "5 + 3 = (+2 more)
...
- **Why does `QuestionContext` connect `Community 50` to `fmt_array_grid.py`, `Community 138`, `Community 11`, `Community 13`, `Community 18`, `test_omission_survives_provenance_but_not_coverage`, `_combined_interests`, `Mutations`, `run_all.py`, `2026-08-20 (tick 7) — The harness now runs its own tests`, `test_planted_mutation_bounds_only_provider_is_caught_by_name`, `Community 51`, `Spine`, `Part 1 — Extending the pipeline`, `Community 59`, `Community 60`, `fractions.py`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 95`, `Community 104`, `Any`, `mastery_drill.py`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `FormattedProblem` connect `test_omission_survives_provenance_but_not_coverage` to `2026-08-14 — "2-digit by 1-digit" bounds two operands, and only one had a key`, `Community 4`, `fmt_array_grid.py`, `Community 138`, `Community 13`, `Community 18`, `_combined_interests`, `Mutations`, `run_all.py`, `2026-08-20 (tick 7) — The harness now runs its own tests`, `test_planted_mutation_bounds_only_provider_is_caught_by_name`, `Community 50`, `Community 51`, `Spine`, `Part 1 — Extending the pipeline`, `Community 59`, `Community 60`, `fractions.py`, `get_gemini_models`, `Community 70`, `Community 75`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `Community 95`, `Community 104`, `Any`, `mastery_drill.py`, `generate_params`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `get_node_info()` connect `1. Local Prototyping: Data Seeding` to `socratic_chat_exchange`, `Community 99`, `Community 4`, `Community 41`, `Community 11`, `Community 75`, `_combined_interests`, `Community 16`, `test_omission_survives_provenance_but_not_coverage`, `hardening_supervisor.py`, `Community 93`?**
