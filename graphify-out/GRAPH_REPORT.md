...
## Corpus Check
- 223 files · ~252,829 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2214 nodes · 3467 edges · 170 communities (165 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bec7af65`
...
Cohesion: 0.08
Nodes (35): CompetencyConfiguration, get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, PydanticBaseModel, _get_available_formats(), get_matatag_difficulty_axes(), get_matatag_lab_config(), get_matatag_lab_interests() (+27 more)
...
Cohesion: 0.04
Nodes (52): Any, Fill template with interest slots and numeric values.                  Handles s, generate_hints(), generate_hints(), generate_hints(), generate_params(), Sample one scenario from the static pool filtered by difficulty profile., _detect_axes_served() (+44 more)
...
Cohesion: 0.06
Nodes (44): _gen_g2_dp_q3_pictograph(), _gen_g2_mg_q1_circles(), _gen_g2_mg_q1_slides(), _gen_g2_mg_q2_measurement(), _gen_g2_mg_q4_perimeter(), _gen_g2_mg_q4_solid_figures(), _gen_g2_mg_q4_time(), _gen_g2_na_q1_addition() (+36 more)
...
Cohesion: 0.07
Nodes (50): get_db(), FastAPI dependency that yields a database session.     Guarantees session closur, SessionLocal(), _combined_interests(), Merge parent-set interest_tags and student-set student_interest_tags into a, Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache(), compute_difficulty_scalar() (+42 more)
...
Cohesion: 0.10
Nodes (23): log_interpolate(), Logarithmic interpolation between min_val and max_val at position t.      Produc, generate_params(), Returns numeric params used by the ruler_measure formatter or word-problem spine, generate_params(), Returns measurement value(s) and the answer.     For 'convert' task: produces va, generate_params(), DNA: Addition (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (ar (+15 more)
...
Cohesion: 0.15
Nodes (25): generate_context(), _import_dna_module(), Generate a format-agnostic QuestionContext from a DNA + node.      Steps:, Dynamically import the DNA module for a given concept name.      Looks up the co, apply_formatter(), generate_batch(), generate_problem(), _get_dna_instance() (+17 more)
...
Cohesion: 0.10
Nodes (27): DimensionSpec, extract_continuous_scalar(), extract_discrete_level(), interpolate(), linear_interpolate(), Practice Generation — DNA Base Definitions  All dataclasses, enums, and shared u, Compute the dimension value at difficulty scalar t.          If override_min/ove, Extracts a discrete level from the difficulty profile.     If the value is a str (+19 more)
...
Cohesion: 0.29
Nodes (7): _expanded_form(), generate_params(), DNA: Place Value (Number & Algebra)  Refactored from:   - matatag_skeletons.py, Return expanded form string, e.g. 3_digit 253 → '200 + 50 + 3'., Insert a zero into a middle position (not leading, not trailing)., Rejection-sample a number and target position that satisfy difficulty_profile., _with_zero_in_middle()
...
Cohesion: 0.17
Nodes (9): get_matatag_competencies(), Return MATATAG competencies for dropdown selection in Problem Lab.          Resp, _combined_interests(), _match_competency_to_visual_type(), Socratic Tutor split-screen dialog endpoint.     Guides the student out of their, Match a MATATAG competency to a visual skeleton type using regex patterns.     R, Merge parent-set interest_tags and student-set student_interest_tags into a, RedisDict (+1 more)
...
Cohesion: 0.25
Nodes (8): generate_hints(), generate_params(), _make_expanded_form(), num_to_tagalog_style_english_words(), Generate a number reading/writing problem.      Returns:         {             ", Return 2–4 step-by-step hints for a number reading/writing problem., Convert a positive integer (1–10000) to Filipino math word style English.      E, Return expanded form string, e.g. '200 + 40 + 3'.
...
Cohesion: 0.38
Nodes (6): generate_params(), DNA: Multiplication (Number & Algebra)  Refactored from:   - matatag_skeletons.p, Return the allowed factor-b values for the given table axis level., Rejection-sample (a, b) that satisfy the difficulty_profile constraints.      Re, _satisfies_number_type(), _table_for_level()
...
Cohesion: 0.50
Nodes (4): get_node_competency_bounds(), _parse_competency_bounds(), Get competency-specific bounds for a node's difficulty dimensions.          Retu, Parse competency text to extract bounds for difficulty dimensions.          Retu
...
- **Why does `DNA` connect `Community 35` to `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 72`, `Community 42`, `Community 11`, `Community 75`, `Community 48`, `Community 52`, `Community 20`, `Community 54`, `Community 55`, `Community 57`, `Community 123`, `Community 92`, `Community 62`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 30` to `Community 130`, `Community 13`, `Community 153`, `Community 39`, `Community 48`, `Community 50`, `Community 51`, `Community 52`, `Community 54`, `Community 55`, `Community 61`, `Community 69`, `Community 70`, `Community 71`, `Community 76`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 98`, `Community 105`, `Community 124`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `FormattedProblem` connect `Community 3` to `Community 130`, `Community 13`, `Community 153`, `Community 30`, `Community 35`, `Community 39`, `Community 50`, `Community 51`, `Community 52`, `Community 55`, `Community 61`, `Community 69`, `Community 70`, `Community 71`, `Community 76`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 98`, `Community 105`, `Community 119`, `Community 124`?**
