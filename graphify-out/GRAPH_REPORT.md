# Graph Report - ccmed  (2026-07-31)

## Corpus Check
- 433 files · ~474,433 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3004 nodes · 4866 edges · 230 communities (218 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 87 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d647a2e0`
...
- [[_COMMUNITY_2. Automated CICD (GitHub Actions Workflows)|2. Automated CI/CD (GitHub Actions Workflows)]]
- [[_COMMUNITY_CCMed — Adaptive K-12 Mastery Engine|CCMed — Adaptive K-12 Mastery Engine]]
- [[_COMMUNITY_fmt_true_false.py|fmt_true_false.py]]
...
9. `set_cache()` - 26 edges
10. `_audit_node()` - 26 edges
...
Cohesion: 0.17
Nodes (18): get_node(), Return the raw knowledge-graph node dict for node_id, or None.      Args:, get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, load_dna(), Import the DNA module and return its DNA instance.     Raises ImportError if loa, lint_all_vocab_gated_instances(), Practice Generation — Vocabulary & Concept Constraint Validation  Verifies that (+10 more)
...
Cohesion: 0.15
Nodes (30): _combined_interests(), Merge parent-set interest_tags and student-set student_interest_tags into a, compute_difficulty_scalar(), get_axes_for_concept(), Practice Generation — Difficulty Axes Catalog ==================================, Return the UI-ready axis list for a concept, or [] if not found., Compute a 0.0–1.0 difficulty scalar from the selected axis values.      For each, _combined_interests() (+22 more)
...
Cohesion: 0.12
Nodes (28): _fraction_str(), generate_hints(), generate_params(), Any, DNA: Fractions (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (f, Rejection-sample a fraction (or pair of fractions) matching difficulty_profile., Return 2–4 step-by-step hint strings for the given fractions problem., _count_decimal_places() (+20 more)
...
Cohesion: 0.22
Nodes (9): 3.1 Rewrite `pgen_checklist.md` → contract + judgment split, 3.2 `DIFFICULTY_DIMENSIONS.md` — keep, but demote MUSTs, 3.3 `INFRASTRUCTURE_WORKFLOW.md` — split and de-poison, 3.4 New file: `docs/DOC_RULES.md`, 3.5 Drift tripwires (cheap, do them), Docs Remediation — Making the docs/ Directory Stop Producing Bugs, Part 2 — The doctrine (rules for every agent-facing doc, permanent), Part 3 — Concrete restructuring of the current docs/ (+1 more)
...
Cohesion: 0.43
Nodes (7): _build_traps(), _build_visual_params(), format_array_grid(), Random, fmt_array_grid.py — ArrayGrid (GridArea) visual formatter  Produces a FormattedP, Build an ArrayGrid FormattedProblem from a QuestionContext.      interaction_mod, Build ArrayGrid visual_params.      Grade 2: arrays up to 10×10 (multiplication

### Community 100 - "Community 100"
Cohesion: 0.27
Nodes (9): generate_hints(), generate_params(), Any, DNA: Multiplication (Number & Algebra)  Refactored from:   - matatag_skeletons.p, Rejection-sample (a, b) that satisfy the difficulty_profile constraints.      Re, Return 2–4 step-by-step hint strings for the given multiplication problem., Return the allowed factor-b values for the given table axis level.      Includes, _satisfies_number_type() (+1 more)
...
### Community 180 - "Spine"
Cohesion: 0.12
Nodes (12): augment_distractors(), Any, Return a list of distractors padded to at least ``target`` items.      Parameter, _build_equation_sentence(), format_cloze(), Random, Textual Formatter — Cloze (Fill-in-the-Blank)  Unified formatter for fill-in-the, Format a QuestionContext as a cloze (fill-in-the-blank) problem.      Respects t (+4 more)
...
Cohesion: 0.07
Nodes (41): Translate a FormattedProblem to the legacy skeleton dict format.      This shim, to_legacy_dict(), get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, True if `level` can be satisfied by some (a, b) with a + b <= max_result., regrouping_is_feasible(), True if `level` can be satisfied by some (a, b) with a <= max_minuend., regrouping_is_feasible() (+33 more)
...
Cohesion: 0.14
Nodes (25): get_all_node_ids(), Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, build_group(), build_packet(), _main(), Any, Practice Generation — Blind Judgment Review Packets  Builds the data a *blind* r, Generate one problem and reduce it to reviewer-facing rendered fields only. (+17 more)

### Community 191 - "Native SQL Examples"
Cohesion: 0.12
Nodes (26): _parse_contract_section_refs(), Practice Generation — Validation Harness Runner  Runs all validators in the prac, Extract every '§1A'-style reference from docs/pgen_contract.md's rule     table, run_all(), count_addition_carries(), count_subtraction_borrows(), get_expected_mapped_value(), get_variant_combinations() (+18 more)

### Community 192 - "counting.py"
Cohesion: 0.29
Nodes (10): generate_hints(), generate_params(), _nudge_off_round(), Any, DNA: Mass and Capacity (Measurement & Geometry)  Covers MATATAG grade 3 mass and, Returns measurement value(s) and the answer.     For 'convert' task: produces va, Pick a sensible rounding granularity for an estimate task by magnitude., Shift a value that is already an exact multiple of its rounding unit.      "An o (+2 more)

### Community 193 - "get_gemini_models"
Cohesion: 0.33
Nodes (9): _build_balance_params(), _build_traps(), format_balance_scale(), Random, fmt_balance_scale.py — BalanceScale visual formatter  NEW formatter — no existin, Build a BalanceScale FormattedProblem from a QuestionContext.      interaction_m, Derive balance-scale parameters from ctx.values.      Expects keys: a, b, result, Return up to 3 distractor values.      Traps:         wrong_op     — adds instea (+1 more)
...
Cohesion: 0.08
Nodes (29): FormattedProblem, Final output of the practice generation pipeline.      Produced by a formatter o, Practice Generation — Hint-Gated Experience Wrapper  Hints unlock one at a time., Apply the hint-gated experience wrapper.      Sets problem.experience to "hint_g, Increment hints_revealed by 1 and return the updated problem.      If the proble, reveal_next_hint(), wrap_hint_gated(), is_mastered() (+21 more)

### Community 197 - "Queries"
Cohesion: 0.40
Nodes (5): PG Pipeline Judgment Guide, The six items, What the enforcer accepts, What this gate does not do, Who reviews, and how

### Community 198 - "get_engine"
Cohesion: 0.22
Nodes (13): Generate a single practice problem and return it as a dict.      This is the sin, run(), _all_node_ids(), _audit_node_grader(), _emit_correct(), main(), Any, Frontend grader-contract round-trip auditor.  Catches the class of bugs where th (+5 more)
...
Cohesion: 0.10
Nodes (19): get_formatters_for_dna(), Return all formatter names compatible with a given DNA concept.      Args:, get_node_dnas(), get_node_formatters(), Return the list of DNA concept names for a node.      Args:         node_id: MAT, Return the union of compatible formatters from all DNAs for a node.      Looks u, PracticeOrchestrator, Any (+11 more)
...
Cohesion: 0.20
Nodes (10): 2026-07-26 audit — the harness was green while not looking, 2026-07-27 — judgment debt converted into enforcement, Blind re-review round, and what it caught, `doc_rem.md` (docs remediation) — done-criteria status, Found, not fixed — prioritized for the maintainer, Headline: what is actually true right now, PG Pipeline — Implementation Status, `pgen_hardening.md` (harness) — per-phase status (+2 more)

### Community 210 - "_get_available_formats"
Cohesion: 0.12
Nodes (14): DNA, Specification of a mathematical concept for practice generation.      dna_type:, Return param_bounds for grade, falling back to nearest defined grade., Return the index of a level within an axis (0 = easiest)., Return a 0.0–1.0 scalar for a given axis level., generate_hints(), generate_params(), Any (+6 more)
...
### Community 221 - "Phase 0 — Consolidate duplicated registries (prerequisite)"
Cohesion: 0.29
...
### Community 224 - "get_pipeline_status"
Cohesion: 0.40
...
### Community 227 - "2. Automated CI/CD (GitHub Actions Workflows)"
Cohesion: 0.50
...
### Community 228 - "CCMed — Adaptive K-12 Mastery Engine"
Cohesion: 0.50
Nodes (4): CCMed — Adaptive K-12 Mastery Engine, Definition of done (pg pipeline), Layout, Start here

## Knowledge Gaps
- **869 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+864 more)
...
- **Why does `FormattedProblem` connect `fmt_ordering.py` to `Community 4`, `Community 8`, `Community 13`, `Community 14`, `Community 153`, `Community 41`, `Community 50`, `Community 51`, `Spine`, `SKILL.md`, `find_node_id`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `get_interest_themes`, `Community 77`, `Community 78`, `Community 79`, `_get_available_formats`, `Community 90`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 99`, `Community 103`, `Community 104`, `Community 118`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 1`, `Community 4`, `Community 13`, `Community 14`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `SKILL.md`, `Community 59`, `Community 60`, `get_gemini_models`, `fmt_ordering.py`, `Community 70`, `Community 77`, `Community 78`, `Community 79`, `Community 90`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 99`, `Community 104`, `Community 118`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `get_available_intro_nodes()` connect `TestBuildTestProfilesVariantCoverage` to `Community 8`, `Community 3`?**
