...
## Corpus Check
- 448 files · ~659,102 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3275 nodes · 5253 edges · 258 communities (241 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a9e4a97b`
...
- [[_COMMUNITY__are_values_equal|_are_values_equal]]
...
- [[_COMMUNITY_interest.py|interest.py]]
- [[_COMMUNITY_fmt_array_grid.py|fmt_array_grid.py]]
...
Cohesion: 0.10
Nodes (15): RedisDict, RedisDict, _get_available_formats(), get_matatag_difficulty_axes(), get_matatag_lab_interests(), get_matatag_nodes(), matatag_lab_submit(), Return which formats are available for a node: ['mcq'], ['visual'], or ['mcq','v (+7 more)
...
Cohesion: 0.09
Nodes (26): decompose_to_places(), generate_hints(), generate_params(), Any, DNA: Addition (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (ar, "N is H hundreds, T tens, and O ones." (place values whose digit is 0     are om, Generate (a, b) that satisfy the difficulty_profile constraints.      Uses smart, # NOTE: "structure" is a contextual variant, not a difficulty dimension. (+18 more)
...
Cohesion: 0.08
Nodes (35): DimensionSpec, extract_continuous_scalar(), extract_discrete_level(), interpolate(), linear_interpolate(), Practice Generation — DNA Base Definitions  All dataclasses, enums, and shared u, Compute the dimension value at difficulty scalar t.          If override_min/ove, Extracts a discrete level from the difficulty profile.     If the value is a str (+27 more)
...
Cohesion: 0.12
Nodes (12): get_dnas_for_formatter(), get_supported_variants(), get_variant_curriculum_gate(), is_compatible(), Any, Practice Generation — DNA-Formatter Compatibility Table ========================, Return variants supported by a specific DNA + formatter combination.      Applie, Validate a lab UI selection and return compatibility info.      Args:         dn (+4 more)
...
Cohesion: 0.20
Nodes (10): 1. Fractions answer-key false positive — `mat_g2_na_q4_0`/`_1`/`_2`, 2026-08-13 — length_measurement: the largest FAIL cluster in the tree, 2. `§1A-reach` false failure — `mat_g3_na_q2_0` (money_peso), 3. KG monotonicity — `order_of_operations` introduced but not propagated, Final Definition of Done, Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02, Phase G — degenerate "estimate" pairs across all four estimate DNAs, 2026-08-04, Three defects, all in the `estimate` branch (+2 more)
...
Cohesion: 0.07
Nodes (44): Any, Registry to map visual types to their Pydantic schemas., VisualSchemaRegistry, _parse_contract_section_refs(), Practice Generation — Validation Harness Runner  Runs all validators in the prac, Extract every '§1A'-style reference from docs/pgen_contract.md's rule     table, run_all(), _are_values_equal() (+36 more)
...
Cohesion: 0.15
Nodes (19): get_node(), Return the raw knowledge-graph node dict for node_id, or None.      Args:, load_dna(), Practice Generation — Validation Manifest  Central source of truth for the valid, Import the DNA module and return its DNA instance.     Raises ImportError if loa, Run validate_difficulty_feasibility for every DNA x every grade present     in t, run_all_feasibility_checks(), lint_all_vocab_gated_instances() (+11 more)
...
### Community 191 - "_are_values_equal"
Cohesion: 0.27
...
Cohesion: 0.17
Nodes (10): get_node_dnas(), get_node_formatters(), Return the list of DNA concept names for a node.      Args:         node_id: MAT, Return the union of compatible formatters from all DNAs for a node.      Looks u, PracticeOrchestrator, Any, Bridge Layer separating the generation logic from the FastAPI routing/server lay, The orchestrator must set problem.dna_name to the actually-chosen DNA. (+2 more)
...
Cohesion: 0.22
Nodes (12): get_formatters_for_dna(), Return all formatter names compatible with a given DNA concept.      Args:, get_pipeline_status(), Any, Return a health-check dict for the pipeline.      Checks:       - Whether each o, _formatters(), test_emoji_formatter_range_gate.py ================================== Emoji-base, The auditor's range-filtered supported_formatters must equal the lab     config' (+4 more)

### Community 223 - "fmt_bar_chart.py"
Cohesion: 0.33
...
### Community 232 - "fmt_ruler_measure.py"
Cohesion: 0.33
...
### Community 248 - "2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared"
Cohesion: 0.40
...
Cohesion: 0.16
Nodes (10): DNA, Specification of a mathematical concept for practice generation.      dna_type:, Return param_bounds for grade, falling back to nearest defined grade., Return the index of a level within an axis (0 = easiest)., Return a 0.0–1.0 scalar for a given axis level., generate_hints(), generate_params(), Any (+2 more)

### Community 265 - "build_scaffold_sequence"
Cohesion: 0.67
Nodes (3): build_scaffold_sequence(), Any, Build an ordered list of difficulty profiles for a scaffold sequence.      Each

## Knowledge Gaps
- **1001 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+996 more)
...
- **Why does `FormattedProblem` connect `Community 4` to `Community 8`, `Community 11`, `Community 13`, `Community 16`, `Community 18`, `Community 24`, `Community 153`, `Community 41`, `Community 50`, `Community 51`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `CompetencyConfiguration`, `test_semantic_leak_guards.py`, `time_reading.py`, `Community 92`, `Community 93`, `calendar.py`, `fmt_bar_chart.py`, `Community 95`, `Community 100`, `CompetencyConfiguration`, `Community 104`, `fmt_ruler_measure.py`, `grader_roundtrip_auditor.py`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 1`, `Community 4`, `Community 11`, `Community 13`, `Community 16`, `Community 18`, `Community 24`, `Community 153`, `Community 41`, `Community 51`, `Community 59`, `Community 60`, `generator.py`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `time_reading.py`, `Community 92`, `Community 93`, `calendar.py`, `fmt_bar_chart.py`, `Community 95`, `Community 100`, `CompetencyConfiguration`, `fmt_ruler_measure.py`, `grader_roundtrip_auditor.py`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `DNA` connect `generate_params` to `Community 1`, `generate_params`, `Community 131`, `Community 4`, `build_scaffold_sequence`, `Community 18`, `Community 24`, `Community 26`, `validate_interest.py`, `mastery_drill.py`, `generator.py`, `validate_capability.py`, `_are_values_equal`, `counting.py`, `Community 75`, `get_interest_themes`, `Community 86`, `Community 87`, `Part 1 — Diagnosis: how the current docs cause bugs`, `frontend_contract_auditor.py`, `Community 101`, `counting.py`, `Community 118`?**
