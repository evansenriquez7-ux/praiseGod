...
## Corpus Check
- 448 files · ~647,242 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3222 nodes · 5195 edges · 251 communities (237 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2d7ea6ac`
...
Cohesion: 0.08
Nodes (33): get_variants_for_dna(), Return all contextual variants defined for a DNA concept.      Args:         dna, _build_symbolic_question(), _detect_axes_served(), _eval_error_formula(), generate_context(), _import_dna_module(), Any (+25 more)
...
Cohesion: 0.10
Nodes (34): apply_formatter(), generate_batch(), generate_problem(), _get_dna_instance(), Any, Random, Practice Generation — API Adapter ===================================  Main entr, Import the DNA module and return its DNA instance. (+26 more)
...
Cohesion: 0.10
Nodes (28): DimensionSpec, extract_continuous_scalar(), extract_discrete_level(), interpolate(), Practice Generation — DNA Base Definitions  All dataclasses, enums, and shared u, Compute the dimension value at difficulty scalar t.          If override_min/ove, Extracts a discrete level from the difficulty profile.     If the value is a str, Extracts a continuous scalar from the difficulty profile.     Handles floats, di (+20 more)
...
Cohesion: 0.11
Nodes (20): decompose_to_places(), generate_hints(), generate_params(), Any, DNA: Addition (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (ar, "N is H hundreds, T tens, and O ones." (place values whose digit is 0     are om, Generate (a, b) that satisfy the difficulty_profile constraints.      Uses smart, # NOTE: "structure" is a contextual variant, not a difficulty dimension. (+12 more)
...
Cohesion: 0.18
Nodes (10): Any, Generate a single practice problem and return it as a dict.      This is the sin, Generate a batch of varied practice problems and return them as dicts.      Args, run(), run_batch(), Mechanical triage for co-mapped-DNA bleed: for every FAIL/CONCERN node mapped to, main(), Differential probe: does forcing a variant value actually change the rendered pr (+2 more)
...
Cohesion: 0.08
Nodes (36): get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, True if `level` can be satisfied by some (a, b) with a + b <= max_result., regrouping_is_feasible(), True if `level` can be satisfied by some (a, b) with a <= max_minuend., regrouping_is_feasible(), _audit_node(), AuditHarnessError (+28 more)
...
Cohesion: 0.08
Nodes (30): _answer_leaks_into_stem(), _normalize_stem(), _numeric_payload_values(), _option_in_stem(), _profile_echo_keys(), Every `given_values` key that is an echo of the request rather than generated, Every plain number a generated problem exposes to the student, labelled for, Lowercase the stem and render LaTeX fractions as 'a/b' so an option like     '1/ (+22 more)
...
Cohesion: 0.13
Nodes (24): is_variant_available_at(), Check if a variant is available at a specific grade/quarter per curriculum., Any, Registry to map visual types to their Pydantic schemas., VisualSchemaRegistry, count_addition_carries(), count_subtraction_borrows(), get_expected_mapped_value() (+16 more)
...
Cohesion: 0.15
Nodes (18): get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, _bound_restricts_to(), _content_words(), _provided_for_node(), Any, Practice Generation — Capability Contract Validator (§6)  The problem this solve, Lowercased alphanumeric tokens of `text`, minus function words. (+10 more)
...
## Knowledge Gaps
- **962 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+957 more)
...
- **Why does `FormattedProblem` connect `test_semantic_leak_guards.py` to `Community 4`, `Community 8`, `Community 13`, `Community 16`, `Community 24`, `Community 153`, `Community 25`, `Community 41`, `Community 50`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `frontend_contract_auditor.py`, `Community 99`, `fmt_numeric_input.py`, `Community 117`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 1`, `Community 4`, `Community 13`, `Community 16`, `Community 24`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `get_engine`, `Community 77`, `Community 79`, `_get_available_formats`, `Community 92`, `Community 93`, `Community 94`, `test_semantic_leak_guards.py`, `frontend_contract_auditor.py`, `Community 95`, `fmt_numeric_input.py`, `Community 117`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `DNA` connect `Community 104` to `Community 1`, `Community 131`, `Community 3`, `Community 11`, `SKILL.md`, `Community 24`, `SKILL.md`, `mastery_drill.py`, `Native SQL Examples`, `Native SQL Examples`, `counting.py`, `get_engine`, `Community 75`, `Community 86`, `Community 87`, `Part 1 — Diagnosis: how the current docs cause bugs`, `calendar.py`, `test_semantic_leak_guards.py`, `Community 100`, `Community 101`, `Ground Rule 2: Spec Corrections & Baseline Fixes`, `Community 118`?**
