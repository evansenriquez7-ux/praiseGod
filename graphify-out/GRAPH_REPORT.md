...
## Corpus Check
- 451 files · ~726,485 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3402 nodes · 5408 edges · 253 communities (243 shown, 10 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 89 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f97e5eee`
...
Cohesion: 0.06
Nodes (50): get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, get_node_dnas(), get_node_formatters(), Return the list of DNA concept names for a node.      Args:         node_id: MAT, Return the union of compatible formatters from all DNAs for a node.      Looks u, _get_available_formats(), get_matatag_lab_config() (+42 more)
...
Cohesion: 0.06
Nodes (41): _answer_leaks_into_stem(), get_variant_combinations(), _normalize_stem(), _numeric_payload_values(), _option_in_stem(), _profile_echo_keys(), Any, Every `given_values` key that is an echo of the request rather than generated (+33 more)
...
Cohesion: 0.10
Nodes (23): Any, Generate a single practice problem and return it as a dict.      This is the sin, Generate a batch of varied practice problems and return them as dicts.      Args, run(), run_batch(), Exception, build(), main() (+15 more)
...
Cohesion: 0.06
Nodes (40): CompetencyConfiguration, get_intro_status(), get_matatag_difficulty_axes(), get_matatag_lab_interests(), get_matatag_nodes(), get_matatag_progress(), get_node_config(), LabV2ConfigSaveRequest (+32 more)
...
Cohesion: 0.05
Nodes (42): get_dnas_for_formatter(), get_variant_curriculum_gate(), get_variants_for_dna(), is_compatible(), is_variant_available_at(), Any, Practice Generation — DNA-Formatter Compatibility Table ========================, Return all contextual variants defined for a DNA concept.      Args:         dna (+34 more)
...
Cohesion: 0.04
Nodes (89): get_node(), Return the raw knowledge-graph node dict for node_id, or None.      Args:, find_node_id(), get_all_node_ids(), get_node_competency_bounds(), get_node_info(), _parse_competency_bounds(), Practice Generation — Node Registry ======================================  Maps (+81 more)
...
- **Why does `FormattedProblem` connect `Community 131` to `generate_params`, `Community 8`, `Community 13`, `Community 18`, `Community 153`, `Community 50`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `validate_capability.py`, `counting.py`, `get_gemini_models`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `run_audit`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 99`, `Community 100`, `CompetencyConfiguration`, `Community 123`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `VisualSchemaRegistry`, `generate_params`, `Community 131`, `Community 13`, `Community 18`, `Community 153`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `counting.py`, `get_gemini_models`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `run_audit`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `get_all_node_ids`, `Community 99`, `Community 100`, `CompetencyConfiguration`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `DNA` connect `generate_params` to `get_all_node_ids`, `VisualSchemaRegistry`, `Community 131`, `Community 101`, `TestLogScaleDeclarations`, `Community 41`, `Community 138`, `get_interest_themes`, `Community 14`, `test_regrouping_feasibility.py`, `Community 118`, `validate_interest.py`, `Native SQL Examples`, `get_node_competency_bounds`, `fractions.py`?**
