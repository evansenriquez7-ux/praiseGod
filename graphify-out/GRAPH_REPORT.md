...
## Corpus Check
- 448 files · ~649,273 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3229 nodes · 5202 edges · 255 communities (242 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe96d4a5`
...
- [[_COMMUNITY_Part 1 — Diagnosis how the current docs cause bugs|Part 1 — Diagnosis: how the current docs cause bugs]]
...
- [[_COMMUNITY_fmt_bar_chart.py|fmt_bar_chart.py]]
- [[_COMMUNITY_fmt_array_grid.py|fmt_array_grid.py]]
...
- [[_COMMUNITY_get_engine|get_engine]]
- [[_COMMUNITY_get_pipeline_status|get_pipeline_status]]
- [[_COMMUNITY_get_node_info|get_node_info]]
...
3. `DNA` - 55 edges
4. `augment_distractors()` - 50 edges
5. `VocabGated` - 36 edges
6. `get_cache()` - 32 edges
7. `ErrorPattern` - 30 edges
8. `generate_pair_by_window()` - 30 edges
9. `get_node_dnas()` - 26 edges
10. `set_cache()` - 26 edges
...
Cohesion: 0.09
Nodes (31): A reusable story template with named slots.      Slots are filled from the stude, Spine, _build_symbolic_question(), _detect_axes_served(), _eval_error_formula(), generate_context(), Any, Practice Generation — Context Generator ======================================== (+23 more)
...
Cohesion: 0.12
Nodes (31): health(), Liveness probe. Reaching this proves the whole module graph imported and     uvi, get_axes_for_concept(), Practice Generation — Difficulty Axes Catalog ==================================, Return the UI-ready axis list for a concept, or [] if not found., Practice Generation — Pipeline Coordinator =====================================, find_node_id(), get_node_formatters() (+23 more)
...
Cohesion: 0.11
Nodes (28): enumerate_profiles(), extract_numerical_limits(), get_dimension_ranges(), _make_predicates(), measure_acceptance_rate(), normalize_difficulty(), Any, Random (+20 more)
...
Cohesion: 0.09
Nodes (26): generate_hints(), generate_params(), Any, Check if a pair satisfies regrouping difficulty based on COUNT of places.      C, True if `level` can be satisfied by some (a, b) with a + b <= max_result., Generate (a, b) that satisfy the difficulty_profile constraints.      Uses smart, Return 2–4 step-by-step hint strings for the given addition problem., regrouping_is_feasible() (+18 more)
...
Cohesion: 0.21
Nodes (19): get_all_node_ids(), Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, _bound_allows(), build_group(), build_packet(), _main(), _max_difficulty_profile(), Any (+11 more)
...
Cohesion: 0.05
Nodes (61): DimensionSpec, DNA, ErrorPattern, extract_continuous_scalar(), extract_discrete_level(), linear_interpolate(), Practice Generation — DNA Base Definitions  All dataclasses, enums, and shared u, A pedagogically meaningful wrong answer.      formula:          SymPy expression (+53 more)
...
Cohesion: 0.10
Nodes (19): Access Levels, @auth Directive, auth.token Fields, Authorization Data Lookup, Authorization Patterns, Available Bindings, CEL Expressions, @check (+11 more)
...
Cohesion: 0.12
Nodes (40): QuestionContext, Format-agnostic intermediate produced by the context generator.      Everything, format_fill_in_table(), Random, _assert_mcq_succeeds(), _calendar_ctx(), _clock_ctx(), _cloze_ctx() (+32 more)
...
Cohesion: 0.17
Nodes (18): _node_file(), _normalize(), _provenance_corpus(), Any, Path, Practice Generation — Judgment Review Validator (hard gate)  The judgment items, Return a list of schema/quality errors for one node's review file., Collapse whitespace so re-rendered text compares on content, not layout. (+10 more)
...
Cohesion: 0.18
Nodes (15): log_interpolate(), Logarithmic interpolation between min_val and max_val at position t.      Produc, generate_hints(), generate_params(), Any, DNA: Length Measurement (Measurement & Geometry)  Covers MATATAG grades 1–2 leng, Returns numeric params used by the ruler_measure formatter or word-problem spine, _standard_unit_bounds() (+7 more)
...
Cohesion: 0.16
Nodes (7): formatter_supports_profile(), Mirror the orchestrator's per-DNA×formatter compatibility check     (backend/app, test_formatter_supports_profile.py =================================== Regressio, The orchestrator must set problem.dna_name to the actually-chosen DNA., formatter_supports_profile must reject formatters not in the     DNA's compatibl, TestFormatterSupportsProfileGate1, TestOrchestratorAnnotatesDnaName
...
Cohesion: 0.16
Nodes (20): Translate a FormattedProblem to the legacy skeleton dict format.      This shim, to_legacy_dict(), _audit_node(), build_test_profiles(), _check_cap_vs_formatter_code(), _check_variant_sensitivity(), _check_visual_capacity(), extract_numeric_state() (+12 more)
...
Cohesion: 0.06
Nodes (49): get_variant_curriculum_gate(), is_variant_available_at(), Return the curriculum introduction point for a variant, or None if no gate., Check if a variant is available at a specific grade/quarter per curriculum., Any, Registry to map visual types to their Pydantic schemas., VisualSchemaRegistry, _parse_contract_section_refs() (+41 more)
...
Cohesion: 0.16
Nodes (13): _distractor_fallback.py — Distractor Augmentation Helper  Per AGENTS.md rule #4:, _build_equation_sentence(), format_cloze(), Random, Textual Formatter — Cloze (Fill-in-the-Blank)  Unified formatter for fill-in-the, Format a QuestionContext as a cloze (fill-in-the-blank) problem.      Respects t, Build pure equation with blank based on concept and blank_target., _build_pure_question() (+5 more)

### Community 211 - "geometric_lines.py"
Cohesion: 0.13
Nodes (20): Generate a single practice problem and return it as a dict.      This is the sin, run(), get_node_competency_bounds(), Get competency-specific bounds for a node's difficulty dimensions.          Retu, Exception, Gated, main(), Pairwise-collapse probe: which declared variant VALUES render identically to eac (+12 more)

### Community 212 - "validate_capability.py"
Cohesion: 0.16
Nodes (16): _bound_restricts_to(), _content_words(), _provided_for_node(), Any, Practice Generation — Capability Contract Validator (§6)  The problem this solve, Lowercased alphanumeric tokens of `text`, minus function words., §6A — a clause the competency does not contain is invented, not declared., §6B — a competency word no clause covers is a requirement silently dropped. (+8 more)
...
Cohesion: 0.12
Nodes (14): Content Rules (student-facing text, DNA files, generators), Definition of Done (memorize this), Engineering Protocols, File Management, Mission, Reporting Style, Terminology, Agent Environment (+6 more)
...
### Community 219 - "Part 1 — Diagnosis: how the current docs cause bugs"
Cohesion: 0.27
...
### Community 222 - ".axis_level_index"
Cohesion: 0.22
...
### Community 223 - "test_semantic_leak_guards.py"
Cohesion: 0.31
...
### Community 224 - "frontend_contract_auditor.py"
Cohesion: 0.33
...
### Community 225 - "fmt_bar_chart.py"
Cohesion: 0.21
...
### Community 226 - "fmt_array_grid.py"
Cohesion: 0.17
Nodes (9): Mutation tests for the capability contract (§6A/§6B/§6C).  These exist because g, A requirement the curriculum never states cannot be declared., The loophole this whole design would otherwise have: drop the requirement you, Ignoring a competency word is possible but visible -- never a silent default., The acceptance test for the entire capability contract: mat_g3_mg_q1_5's     com, test_invention_is_caught_by_provenance(), test_omission_survives_provenance_but_not_coverage(), test_requires_ignore_must_be_explicit_to_excuse_a_word() (+1 more)
...
### Community 230 - "fmt_numeric_input.py"
Cohesion: 0.43
...
### Community 234 - "run"
Cohesion: 0.33
Nodes (8): generate_hints(), generate_params(), Any, Random, DNA: Area (Measurement & Geometry)  Covers MATATAG grade 3 area competencies onl, Returns side dimensions and the area answer.     For find_missing_dimension task, A (table_factor, co_factor) pair whose product is a known-table fact at G3 Q1., _table_and_cofactor()
...
### Community 239 - "get_pipeline_status"
Cohesion: 0.50
...
### Community 240 - "get_node_info"
Cohesion: 0.29
Nodes (5): get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, Run run_vocab_audit for every node in the knowledge graph (full-node mode),, run_all_vocab_audits(), Mechanical triage for co-mapped-DNA bleed: for every FAIL/CONCERN node mapped to
...
Cohesion: 0.29
Nodes (7): 2026-08-13 — Tick F: building the inductive derivation (mat_g3_mg_q1_1), A hole this exposed in §6C itself, Step 1 — prove it doesn't already exist, Step 2 — what was built, Step 3 — the capability contract, The gap, named by both the reviewer and §6C, Verification — rendered samples
...
### Community 247 - "socratic_chat_exchange"
Cohesion: 0.40
...
- **Why does `FormattedProblem` connect `Community 4` to `Community 8`, `Community 13`, `Community 16`, `Community 24`, `Community 153`, `Community 25`, `Community 41`, `Community 50`, `Community 51`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `Community 92`, `Community 93`, `Community 94`, `test_semantic_leak_guards.py`, `frontend_contract_auditor.py`, `Community 95`, `Community 99`, `CompetencyConfiguration`, `fmt_numeric_input.py`, `run`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 1`, `Community 4`, `Community 13`, `Community 16`, `Community 24`, `Community 153`, `Community 41`, `Community 51`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `get_engine`, `Community 77`, `Community 79`, `_get_available_formats`, `Community 92`, `Community 93`, `Community 94`, `test_semantic_leak_guards.py`, `frontend_contract_auditor.py`, `Community 95`, `CompetencyConfiguration`, `fmt_numeric_input.py`, `run`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `DNA` connect `Community 24` to `counting.py`, `Community 1`, `Community 3`, `Community 100`, `Community 101`, `Community 4`, `get_engine`, `run`, `Community 75`, `Community 11`, `get_interest_themes`, `SKILL.md`, `Community 86`, `Community 118`, `build_scaffold_sequence`, `Part 1 — Diagnosis: how the current docs cause bugs`, `calendar.py`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
