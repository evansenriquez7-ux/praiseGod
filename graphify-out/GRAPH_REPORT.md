...
## Corpus Check
- 448 files · ~662,656 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3292 nodes · 5271 edges · 264 communities (247 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0062ecee`
...
9. `Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02` - 29 edges
...
Cohesion: 0.06
Nodes (65): get_all_node_ids(), Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, _bound_allows(), build_group(), build_packet(), _main(), _max_difficulty_profile(), Any (+57 more)

### Community 186 - "get_node_competency_bounds"
Cohesion: 0.08
Nodes (38): get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, True if `level` can be satisfied by some (a, b) with a <= max_minuend., regrouping_is_feasible(), _audit_node(), _axis_scale(), build_test_profiles(), _check_cap_vs_formatter_code() (+30 more)

### Community 187 - "generator.py"
Cohesion: 0.15
Nodes (19): get_node(), Return the raw knowledge-graph node dict for node_id, or None.      Args:, get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, load_dna(), Practice Generation — Validation Manifest  Central source of truth for the valid, Import the DNA module and return its DNA instance.     Raises ImportError if loa, lint_all_vocab_gated_instances() (+11 more)
...
Cohesion: 0.15
Nodes (16): Generate a single practice problem and return it as a dict.      This is the sin, run(), Mechanical triage for co-mapped-DNA bleed: for every FAIL/CONCERN node mapped to, _all_node_ids(), _audit_node_grader(), _emit_correct(), main(), Any (+8 more)
...
### Community 219 - "grader_roundtrip_auditor.py"
Cohesion: 0.14
...
Cohesion: 0.14
Nodes (19): get_node_competency_bounds(), _parse_competency_bounds(), Parse competency text to extract bounds for difficulty dimensions.      Returns, Get competency-specific bounds for a node's difficulty dimensions.          Retu, get_matatag_lab_config(), Return full lab configuration for a MATATAG node.      Includes:     - difficult, Exception, Gated (+11 more)
...
### Community 225 - "compute_difficulty_scalar"
Cohesion: 0.27
...
### Community 232 - "mastery_drill.py"
Cohesion: 0.33
...
### Community 249 - "_combined_interests"
Cohesion: 0.40
...
### Community 253 - "_combined_interests"
Cohesion: 0.40
...
### Community 254 - "socratic_chat_exchange"
Cohesion: 0.40
...
Cohesion: 0.06
Nodes (51): DimensionSpec, ErrorPattern, extract_continuous_scalar(), extract_discrete_level(), interpolate(), linear_interpolate(), Practice Generation — DNA Base Definitions  All dataclasses, enums, and shared u, Compute the dimension value at difficulty scalar t.          If override_min/ove (+43 more)

## Knowledge Gaps
- **1013 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+1008 more)
...
- **Why does `FormattedProblem` connect `Community 3` to `fmt_fill_in_table.py`, `generate_params`, `Community 4`, `Community 8`, `Community 11`, `Community 13`, `Community 16`, `Community 153`, `Community 41`, `Community 50`, `Community 51`, `Community 59`, `Community 60`, `_are_values_equal`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `time_reading.py`, `Community 92`, `Community 93`, `fmt_bar_chart.py`, `Community 95`, `Community 99`, `Community 100`, `CompetencyConfiguration`, `fmt_pictograph.py`, `mastery_drill.py`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `DNA` connect `get_interest_themes` to `Community 1`, `generate_params`, `Community 131`, `Community 3`, `Community 18`, `Community 24`, `mastery_drill.py`, `generator.py`, `matatag_loader.py`, `validate_capability.py`, `counting.py`, `Community 75`, `Community 86`, `Community 87`, `Native SQL Examples`, `frontend_contract_auditor.py`, `compute_difficulty_scalar`, `Community 101`, `counting.py`, `Community 118`, `_combined_interests`, `health`, `find_node_id`, `_combined_interests`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `fmt_fill_in_table.py`, `Community 1`, `generate_params`, `Community 3`, `Community 4`, `Community 11`, `Community 13`, `Community 16`, `Community 153`, `Community 41`, `Community 51`, `Community 59`, `Community 60`, `generator.py`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `time_reading.py`, `Community 92`, `Community 93`, `fmt_bar_chart.py`, `Community 95`, `Community 100`, `CompetencyConfiguration`, `fmt_pictograph.py`?**
