...
## Corpus Check
- 648 files · ~1,227,062 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4621 nodes · 6952 edges · 370 communities (324 shown, 46 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 102 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `25da721a`
...
Cohesion: 0.05
Nodes (47): Translate a FormattedProblem to the legacy skeleton dict format.      This shim, to_legacy_dict(), get_matatag_lab_config(), Return full lab configuration for a MATATAG node.      Includes:     - difficult, _audit_node(), AuditHarnessError, build_test_profiles(), _check_cap_vs_formatter_code() (+39 more)
...
Cohesion: 0.12
Nodes (33): get_db(), FastAPI dependency that yields a database session.     Guarantees session closur, SessionLocal(), Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache(), Practice Generation — Difficulty Axes Catalog ==================================, Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache() (+25 more)

### Community 9 - "Community 9"
Cohesion: 0.12
Nodes (24): CompetencyConfiguration, collect_findings(), main(), §10 — the grading contract: a correct answer must be graded correct, by every gr, Every (node, seed) where a known-correct answer is not graded correct by all thr, validate_all(), LabV2ConfigSaveRequest, LabV2GenerateRequest (+16 more)
...
Cohesion: 0.05
Nodes (73): get_axes_for_concept(), Return the UI-ready axis list for a concept, or [] if not found., get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, Any, Registry to map visual types to their Pydantic schemas., VisualSchemaRegistry, _are_values_equal() (+65 more)
...
Cohesion: 0.05
Nodes (56): get_dnas_for_formatter(), get_variant_curriculum_gate(), is_compatible(), is_variant_available_at(), Any, Practice Generation — DNA-Formatter Compatibility Table ========================, Validate a lab UI selection and return compatibility info.      Args:         dn, Return the curriculum introduction point for a variant, or None if no gate. (+48 more)
...
Cohesion: 0.06
Nodes (62): get_all_node_ids(), get_node_competency_bounds(), get_node_formatters(), get_node_info(), Get competency-specific bounds for a node's difficulty dimensions.          Retu, Return the union of compatible formatters from all DNAs for a node.      Looks u, Return the full knowledge-graph node dict for a node.      Args:         node_id, Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return (+54 more)
...
Cohesion: 0.07
Nodes (36): decompose_to_places(), generate_hints(), generate_params(), max_regrouping_places(), Any, DNA: Addition (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (ar, Return 2–4 step-by-step hint strings for the given addition problem., "N is H hundreds, T tens, and O ones." (place values whose digit is 0     are om (+28 more)

### Community 275 - "test_attestation_without_samples_cannot_be_checked_and_fails"
Cohesion: 0.09
Nodes (31): _parse_contract_section_refs(), Practice Generation — Validation Harness Runner  Runs all validators in the prac, Run the fast unit suite and report it as a harness stage (§0).      Subprocess r, Extract every '§1A'-style reference from docs/pgen_contract.md's rule     table, run_all(), _run_unit_tests(), count_mutations(), count_nodes() (+23 more)
...
- **Why does `FormattedProblem` connect `Community 41` to `generate_params`, `Community 4`, `Community 3`, `.axis_level_index`, `fmt_numeric_input.py`, `fmt_array_grid.py`, `Community 138`, `Community 8`, `Community 13`, `test_regrouping_feasibility.py`, `Community 18`, `2026-08-13 — The G1 measure items: a visual for the task, and a size model for the units`, `Community 50`, `Community 51`, `Spine`, `validate_interest.py`, `1. Local Prototyping: Data Seeding`, `Community 59`, `Community 60`, `fractions.py`, `get_gemini_models`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `Community 95`, `get_all_node_ids`, `socratic_chat_exchange`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `generate_params`, `.axis_level_index`, `fmt_numeric_input.py`, `Community 138`, `Community 13`, `test_regrouping_feasibility.py`, `Community 18`, `2026-08-13 — The G1 measure items: a visual for the task, and a size model for the units`, `Community 41`, `Community 51`, `Spine`, `1. Local Prototyping: Data Seeding`, `Community 59`, `Community 60`, `fractions.py`, `get_gemini_models`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `Community 95`, `get_all_node_ids`, `socratic_chat_exchange`, `Community 117`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `get_node_info()` connect `2026-08-13 — Content no competency asks for, and a metre wearing centimetres` to `Community 99`, `Community 4`, `Community 102`, `Community 104`, `Community 41`, `Community 8`, `Community 11`, `test_unattested_capability_is_a_failure_not_a_skip`, `Community 16`, `Community 117`, `hardening_supervisor.py`, `Community 153`?**
