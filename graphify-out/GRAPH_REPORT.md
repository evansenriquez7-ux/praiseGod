...
## Corpus Check
- 336 files · ~510,888 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3074 nodes · 5005 edges · 227 communities (218 shown, 9 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6d8385f8`
...
## Communities (227 total, 9 thin omitted)
...
Cohesion: 0.17
Nodes (23): _combined_interests(), Merge parent-set interest_tags and student-set student_interest_tags into a, get_axes_for_concept(), Practice Generation — Difficulty Axes Catalog ==================================, Return the UI-ready axis list for a concept, or [] if not found., _combined_interests(), Merge parent-set interest_tags and student-set student_interest_tags into a, get_node_capabilities() (+15 more)
...
Cohesion: 0.12
Nodes (17): generate_hints(), Any, True if `level` can be satisfied by some (a, b) with a + b <= max_result., Return 2–4 step-by-step hint strings for the given addition problem., regrouping_is_feasible(), generate_hints(), Any, True if `level` can be satisfied by some (a, b) with a <= max_minuend. (+9 more)
...
Cohesion: 0.07
Nodes (48): generate_params(), Generate (a, b) that satisfy the difficulty_profile constraints.      Uses smart, _fraction_str(), _fraction_words(), generate_hints(), generate_params(), Any, DNA: Fractions (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (f (+40 more)
...
Cohesion: 0.08
Nodes (33): log_interpolate(), Logarithmic interpolation between min_val and max_val at position t.      Produc, generate_hints(), generate_params(), Any, DNA: Length Measurement (Measurement & Geometry)  Covers MATATAG grades 1–2 leng, Returns numeric params used by the ruler_measure formatter or word-problem spine, _standard_unit_bounds() (+25 more)
...
Cohesion: 0.16
Nodes (14): max_regrouping_places(), Check if a pair satisfies regrouping difficulty based on COUNT of places.      C, Largest carry count physically achievable for any (a, b) with a + b <= max_resul, _satisfies_regrouping(), _borrows(), _brute_max_borrows(), _brute_max_carries(), _carries() (+6 more)
...
Cohesion: 0.08
Nodes (35): get_gemini_models(), get_parent_analytics(), get_parent_config(), get_parent_graph(), parent_login(), Any, Session, Parent Dashboard compiling telemetry statistics, Elo progress, and skills master (+27 more)
...
Cohesion: 0.03
Nodes (85): DimensionSpec, DNA, ErrorPattern, extract_continuous_scalar(), extract_discrete_level(), interpolate(), linear_interpolate(), Practice Generation — DNA Base Definitions  All dataclasses, enums, and shared u (+77 more)
...
Cohesion: 0.13
Nodes (23): Translate a FormattedProblem to the legacy skeleton dict format.      This shim, to_legacy_dict(), _audit_node(), _check_cap_vs_formatter_code(), _check_variant_sensitivity(), _check_visual_capacity(), extract_numeric_state(), get_lab_config() (+15 more)
...
Cohesion: 0.05
Nodes (62): get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, enumerate_profiles(), Return every combination of difficulty axis levels for a DNA.      Iterates over, Any, Registry to map visual types to their Pydantic schemas., VisualSchemaRegistry, load_dna() (+54 more)
...
Cohesion: 0.06
Nodes (50): get_node(), Return the raw knowledge-graph node dict for node_id, or None.      Args:, get_pipeline_status(), Any, Practice Generation — Pipeline Coordinator =====================================, Return a health-check dict for the pipeline.      Checks:       - Whether each o, Generate a batch of varied practice problems and return them as dicts.      Args, run_batch() (+42 more)
...
## Knowledge Gaps
- **886 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+881 more)
...
- **Why does `FormattedProblem` connect `Community 4` to `Community 3`, `Community 8`, `Community 13`, `Community 16`, `SKILL.md`, `Community 153`, `Community 41`, `Community 50`, `Community 51`, `SKILL.md`, `find_node_id`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `fmt_ordering.py`, `get_engine`, `Community 70`, `Community 77`, `Community 78`, `Community 79`, `time_reading.py`, `Community 90`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 99`, `Community 118`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 4`, `Community 13`, `Community 16`, `SKILL.md`, `Community 153`, `Community 41`, `Community 51`, `SKILL.md`, `Community 59`, `Community 60`, `get_gemini_models`, `fmt_ordering.py`, `Community 70`, `Community 77`, `Community 78`, `Community 79`, `geometric_lines.py`, `time_reading.py`, `Community 90`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 99`, `Community 118`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `get_available_intro_nodes()` connect `Community 117` to `Community 8`, `Section 7: i18n chrome audit`?**
