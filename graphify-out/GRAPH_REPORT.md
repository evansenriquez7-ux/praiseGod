...
## Corpus Check
- 443 files · ~628,616 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3109 nodes · 5041 edges · 242 communities (224 shown, 18 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `40a8531e`
...
## Communities (242 total, 18 thin omitted)
...
Cohesion: 0.14
Nodes (20): _detect_axes_served(), _eval_error_formula(), generate_context(), _import_dna_module(), Any, Practice Generation — Context Generator ========================================, Back-infer which difficulty axis levels were actually produced.      Checks the, Generate a format-agnostic QuestionContext from a DNA + node.      Steps: (+12 more)
...
Cohesion: 0.09
Nodes (25): find_node_id(), get_node_competency_bounds(), get_node_dnas(), get_node_formatters(), _parse_competency_bounds(), Practice Generation — Node Registry ======================================  Maps, Parse competency text to extract bounds for difficulty dimensions.      Returns, # NOTE: `max_difference` was removed from this list on 2026-07-01. (+17 more)
...
Cohesion: 0.06
Nodes (42): Translate a FormattedProblem to the legacy skeleton dict format.      This shim, to_legacy_dict(), get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, _audit_node(), AuditHarnessError, build_test_profiles(), _check_cap_vs_formatter_code() (+34 more)
...
Cohesion: 0.06
Nodes (59): _bound_allows(), build_group(), build_packet(), _main(), _max_difficulty_profile(), Any, Practice Generation — Blind Judgment Review Packets  Builds the data a *blind* r, Generate one problem and reduce it to reviewer-facing rendered fields only. (+51 more)

### Community 191 - "Native SQL Examples"
Cohesion: 0.06
Nodes (52): get_variant_curriculum_gate(), is_variant_available_at(), Return the curriculum introduction point for a variant, or None if no gate., Check if a variant is available at a specific grade/quarter per curriculum., get_all_node_ids(), Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, Any, Registry to map visual types to their Pydantic schemas. (+44 more)
...
Cohesion: 0.07
Nodes (31): ErrorPattern, A pedagogically meaningful wrong answer.      formula:          SymPy expression, A mathematical term fragment gated behind vocab knowledge.      preferred:    Te, VocabGated, generate_hints(), generate_params(), Any, DNA: Probability Language (Data & Probability)  Covers MATATAG grade 3 probabili (+23 more)
...
## Knowledge Gaps
- **914 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+909 more)
...
- **Why does `FormattedProblem` connect `Community 4` to `Community 8`, `Community 13`, `Community 14`, `Community 16`, `SKILL.md`, `Community 24`, `Community 153`, `Community 41`, `Community 50`, `Community 51`, `SKILL.md`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 78`, `Community 79`, `Community 92`, `Community 93`, `Community 94`, `generate_params`, `Community 95`, `Community 99`, `Community 104`, `Community 117`, `Community 118`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 1`, `Community 4`, `Community 13`, `Community 14`, `Community 16`, `SKILL.md`, `Community 24`, `Community 153`, `Community 41`, `Community 51`, `SKILL.md`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 78`, `Community 79`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `validate_interest.py`, `Community 104`, `Community 118`?**
