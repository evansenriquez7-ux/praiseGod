...
## Corpus Check
- 450 files · ~722,320 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3372 nodes · 5366 edges · 269 communities (252 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fce7f8df`
...
- [[_COMMUNITY_health|health]]
- [[_COMMUNITY__combined_interests|_combined_interests]]
- [[_COMMUNITY_get_intro_status|get_intro_status]]
- [[_COMMUNITY_mark_intro_viewed|mark_intro_viewed]]
- [[_COMMUNITY__combined_interests|_combined_interests]]
...
5. `Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02` - 39 edges
...
Cohesion: 0.05
Nodes (46): get_dnas_for_formatter(), get_variant_curriculum_gate(), is_compatible(), Practice Generation — DNA-Formatter Compatibility Table ========================, Return the curriculum introduction point for a variant, or None if no gate., Return True if the formatter is compatible with the given DNA concept.      Args, Return all DNA concept names that support a given formatter.      Performs a rev, find_node_id() (+38 more)

### Community 4 - "Community 4"
Cohesion: 0.13
Nodes (27): get_all_node_ids(), get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, _bound_allows(), build_group(), build_packet(), _main() (+19 more)
...
Cohesion: 0.40
Nodes (5): get_supported_variants(), Any, Return variants supported by a specific DNA + formatter combination.      Applie, Validate a lab UI selection and return compatibility info.      Args:         dn, validate_lab_selection()
...
Cohesion: 0.12
Nodes (21): log_interpolate(), Logarithmic interpolation between min_val and max_val at position t.      Produc, generate_hints(), generate_params(), _inverse_op(), Any, DNA: Missing Number (Number & Algebra)  Covers MATATAG grades 1–3 missing-number, Rejection-sample a missing-number equation matching difficulty_profile.      Ret (+13 more)
...
Cohesion: 0.16
Nodes (10): get_matatag_difficulty_axes(), get_matatag_lab_interests(), get_matatag_nodes(), get_matatag_progress(), matatag_lab_submit(), Get a student's MATATAG progress organized by content area with grade/quarter po, Return the difficulty axes for a specific MATATAG node.      Axes are specific t, Return ALL available interest themes for word problem personalization. (+2 more)
...
Cohesion: 0.15
Nodes (21): _audit_node(), build_test_profiles(), _check_cap_vs_formatter_code(), _check_variant_sensitivity(), _check_visual_capacity(), extract_numeric_state(), get_lab_config(), _import_harness_dependencies() (+13 more)
...
Cohesion: 0.16
Nodes (19): _build_traps(), _build_visual_params(), format_array_grid(), Random, fmt_array_grid.py — ArrayGrid (GridArea) visual formatter  Produces a FormattedP, Write `terms` copies of `addend` as a repeated sum, or describe it when     writ, Build an ArrayGrid FormattedProblem from a QuestionContext.      interaction_mod, Build ArrayGrid visual_params.      Grade 2: arrays up to 10×10 (multiplication (+11 more)

### Community 211 - "_manifest.py"
Cohesion: 0.40
...
Cohesion: 0.29
Nodes (9): get_matatag_lab_config(), _get_max_regrouping_places(), Max regrouping/borrowing places feasible for a given number range.      Thin wra, Return full lab configuration for a MATATAG node.      Includes:     - difficult, _formatters(), test_emoji_formatter_range_gate.py ================================== Emoji-base, test_emoji_dropped_on_grade3_large_range(), test_emoji_dropped_when_range_just_over_100() (+1 more)
...
Cohesion: 0.06
Nodes (34): ErrorPattern, A pedagogically meaningful wrong answer.      formula:          SymPy expression, A mathematical term fragment gated behind vocab knowledge.      preferred:    Te, VocabGated, generate_hints(), generate_params(), Any, DNA: Probability Experiment (Data & Probability)  Covers MATATAG grade 3 compete (+26 more)

### Community 222 - "models.py"
Cohesion: 0.29
Nodes (7): generate_hints(), generate_params(), Any, DNA: Addition (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (ar, Generate (a, b) that satisfy the difficulty_profile constraints.      Uses smart, # NOTE: "structure" is a contextual variant, not a difficulty dimension., Return 2–4 step-by-step hint strings for the given addition problem.

### Community 223 - "fmt_numeric_input.py"
Cohesion: 0.25
Nodes (8): LabV2ConfigSaveRequest, LabV2GenerateRequest, LabV2SubmitRequest, matatag_lab_v2_submit(), Request body for /api/matatag/lab/v2/generate, Request body for /api/matatag/lab/v2/submit, Grade an answer from the v2 pipeline.      Handles all formatter types:     - mc, PydanticBaseModel
...
Cohesion: 0.08
Nodes (35): get_axes_for_concept(), Return the UI-ready axis list for a concept, or [] if not found., get_variants_for_dna(), is_variant_available_at(), Return all contextual variants defined for a DNA concept.      Args:         dna, Check if a variant is available at a specific grade/quarter per curriculum., _build_symbolic_question(), _detect_axes_served() (+27 more)
...
### Community 248 - "time_reading.py"
Cohesion: 0.29
Nodes (7): matatag_lab_generate(), matatag_lab_v2_generate(), Session, Save the enabled checkboxes for a node, with curriculum validation., Generate a practice problem using the new practice_gen pipeline., Generate a practice problem for the MATATAG Problem Lab.      Works for ALL 151, save_node_config()

### Community 249 - "mastery_drill.py"
Cohesion: 0.33
...
Cohesion: 0.11
Nodes (23): max_regrouping_places(), Check if a pair satisfies regrouping difficulty based on COUNT of places.      C, Largest carry count physically achievable for any (a, b) with a + b <= max_resul, True if `level` can be satisfied by some (a, b) with a + b <= max_result., regrouping_is_feasible(), _satisfies_regrouping(), _axis_scale(), _map_scalar_to_range() (+15 more)
...
## Knowledge Gaps
- **1056 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+1051 more)
...
- **Why does `FormattedProblem` connect `Community 131` to `generate_params`, `Community 8`, `Community 13`, `Community 18`, `Community 153`, `Community 25`, `Community 50`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `validate_capability.py`, `get_gemini_models`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `run_audit`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 100`, `CompetencyConfiguration`, `Community 102`, `fmt_pictograph.py`, `_combined_interests`, `mastery_drill.py`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `generate_params`, `Community 131`, `Community 13`, `Community 18`, `Community 153`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `validate_capability.py`, `get_gemini_models`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `run_audit`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `get_all_node_ids`, `Community 99`, `Community 100`, `CompetencyConfiguration`, `fmt_pictograph.py`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `DNA` connect `validate_interest.py` to `fmt_fill_in_table.py`, `Community 1`, `generate_params`, `Community 131`, `Community 14`, `counting.py`, `Community 24`, `Community 41`, `mastery_drill.py`, `Native SQL Examples`, `fractions.py`, `counting.py`, `Community 87`, `Native SQL Examples`, `models.py`, `get_all_node_ids`, `Community 99`, `Community 101`, `TestLogScaleDeclarations`, `health`, `Community 118`?**
