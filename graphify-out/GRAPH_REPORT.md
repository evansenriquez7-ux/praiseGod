...
## Corpus Check
- 448 files · ~661,201 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3280 nodes · 5258 edges · 248 communities (233 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `755eb339`
...
9. `Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02` - 27 edges
...
Cohesion: 0.10
Nodes (20): Any, A reusable story template with named slots.      Slots are filled from the stude, Fill template with interest slots and numeric values.                  Handles s, Serialize to dict for API response., Spine, Practice Generation — Context Generator ========================================, _contains_forbidden_term(), get_grade_appropriate_interests() (+12 more)
...
Cohesion: 0.06
Nodes (51): Attempt, CompetencyConfiguration, MasteryState, NodeIntroView, ParentAccount, QuestionFlag, SkillEdge, SkillNode (+43 more)
...
Cohesion: 0.10
Nodes (31): True if `level` can be satisfied by some (a, b) with a + b <= max_result., regrouping_is_feasible(), True if `level` can be satisfied by some (a, b) with a <= max_minuend., regrouping_is_feasible(), _audit_node(), _axis_scale(), build_test_profiles(), _check_cap_vs_formatter_code() (+23 more)
...
Cohesion: 0.09
Nodes (23): generate_hints(), generate_params(), Any, Generate (a, b) that satisfy the difficulty_profile constraints.      Uses smart, Return 2–4 step-by-step hint strings for the given addition problem., generate_hints(), generate_params(), _inverse_op() (+15 more)
...
Cohesion: 0.10
Nodes (23): is_variant_available_at(), Check if a variant is available at a specific grade/quarter per curriculum., _build_symbolic_question(), _detect_axes_served(), _eval_error_formula(), generate_context(), Any, Generate a format-agnostic QuestionContext from a DNA + node.      Steps: (+15 more)
...
## Knowledge Gaps
- **1005 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+1000 more)
...
- **Why does `FormattedProblem` connect `Community 4` to `Community 1`, `generate_params`, `Community 3`, `Community 8`, `Community 11`, `Community 13`, `Community 16`, `Community 153`, `Community 25`, `Community 41`, `Community 50`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `test_semantic_leak_guards.py`, `time_reading.py`, `Community 92`, `Community 93`, `fmt_bar_chart.py`, `Community 95`, `Community 100`, `CompetencyConfiguration`, `Community 104`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 1`, `generate_params`, `Community 3`, `Community 4`, `Community 11`, `Community 13`, `Community 16`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `generator.py`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `test_semantic_leak_guards.py`, `time_reading.py`, `Community 92`, `Community 93`, `fmt_bar_chart.py`, `Community 95`, `Community 100`, `CompetencyConfiguration`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `DNA` connect `get_interest_themes` to `frontend_contract_auditor.py`, `counting.py`, `Community 1`, `generate_params`, `Community 131`, `Community 101`, `Community 4`, `counting.py`, `Community 75`, `Community 18`, `mastery_drill.py`, `test_semantic_leak_guards.py`, `Community 86`, `Community 118`, `Community 24`, `generator.py`, `validate_capability.py`, `_are_values_equal`?**
