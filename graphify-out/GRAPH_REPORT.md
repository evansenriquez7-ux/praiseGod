...
## Corpus Check
- 448 files · ~661,553 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3287 nodes · 5266 edges · 255 communities (246 shown, 9 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d7a615ce`
...
9. `Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02` - 28 edges
...
## Communities (255 total, 9 thin omitted)
...
Cohesion: 0.08
Nodes (35): get_variants_for_dna(), is_variant_available_at(), Return all contextual variants defined for a DNA concept.      Args:         dna, Check if a variant is available at a specific grade/quarter per curriculum., _build_symbolic_question(), _detect_axes_served(), _eval_error_formula(), generate_context() (+27 more)
...
Cohesion: 0.13
Nodes (23): CompetencyConfiguration, LabV2ConfigSaveRequest, LabV2GenerateRequest, LabV2SubmitRequest, matatag_lab_v2_submit(), Request body for /api/matatag/lab/v2/generate, Request body for /api/matatag/lab/v2/submit, Save the enabled checkboxes for a node, with curriculum validation. (+15 more)
...
Cohesion: 0.11
Nodes (19): get_interest_themes(), Return all interest themes. Grade parameter is ignored (kept for API compatibili, _combined_interests(), get_intro_content(), get_intro_status(), get_matatag_progress(), get_node_config(), list_intro_interests() (+11 more)
...
Cohesion: 0.06
Nodes (63): get_all_node_ids(), Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, _bound_allows(), build_group(), build_packet(), _main(), _max_difficulty_profile(), Any (+55 more)

### Community 186 - "get_node_competency_bounds"
Cohesion: 0.08
Nodes (35): _audit_node(), AuditHarnessError, _axis_scale(), build_test_profiles(), _check_cap_vs_formatter_code(), check_checklist_compliance(), _check_variant_sensitivity(), _check_visual_capacity() (+27 more)
...
Cohesion: 0.11
Nodes (19): Any, Generate a single practice problem and return it as a dict.      This is the sin, Generate a batch of varied practice problems and return them as dicts.      Args, run(), run_batch(), get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, matatag_lab_v2_generate() (+11 more)
...
## Knowledge Gaps
- **1009 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+1004 more)
...
- **Why does `FormattedProblem` connect `Community 3` to `generate_params`, `Community 4`, `Community 8`, `Community 11`, `Community 13`, `Community 16`, `Community 18`, `Community 153`, `Community 41`, `Community 50`, `Community 51`, `Community 59`, `Community 60`, `_are_values_equal`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `time_reading.py`, `Community 92`, `Community 93`, `fmt_bar_chart.py`, `Community 95`, `Community 99`, `Community 100`, `CompetencyConfiguration`, `fmt_pictograph.py`, `Community 104`, `mastery_drill.py`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `DNA` connect `generate_params` to `Community 1`, `Community 131`, `Community 14`, `Community 18`, `Community 24`, `Community 26`, `Community 36`, `generator.py`, `matatag_loader.py`, `validate_capability.py`, `counting.py`, `Community 75`, `get_interest_themes`, `Community 86`, `frontend_contract_auditor.py`, `Community 101`, `counting.py`, `.axis_level_index`, `Community 118`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 1`, `generate_params`, `Community 3`, `Community 4`, `Community 11`, `Community 13`, `Community 16`, `Community 18`, `Community 153`, `Community 41`, `Community 51`, `Community 59`, `Community 60`, `generator.py`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `time_reading.py`, `Community 92`, `Community 93`, `fmt_bar_chart.py`, `Community 95`, `Community 100`, `CompetencyConfiguration`, `fmt_pictograph.py`?**
