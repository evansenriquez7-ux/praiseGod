...
## Corpus Check
- 451 files · ~725,873 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3399 nodes · 5405 edges · 263 communities (251 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 89 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8e523cc4`
...
5. `Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02` - 41 edges
...
## Communities (263 total, 12 thin omitted)
...
Cohesion: 0.14
Nodes (22): Translate a FormattedProblem to the legacy skeleton dict format.      This shim, to_legacy_dict(), _audit_node(), build_test_profiles(), _check_cap_vs_formatter_code(), _check_variant_sensitivity(), _check_visual_capacity(), extract_numeric_state() (+14 more)
...
Cohesion: 0.07
Nodes (59): get_db(), FastAPI dependency that yields a database session.     Guarantees session closur, SessionLocal(), _combined_interests(), health(), Merge parent-set interest_tags and student-set student_interest_tags into a, Background task to pre-generate questions into the cache.     Uses parallel exec, Liveness probe. Reaching this proves the whole module graph imported and     uvi (+51 more)
...
Cohesion: 0.13
Nodes (15): 1. Fractions answer-key false positive — `mat_g2_na_q4_0`/`_1`/`_2`, 2026-08-13 — "less than N" was parsed as "up to N", 2026-08-14 — "2-digit by 1-digit" bounds two operands, and only one had a key, 2. `§1A-reach` false failure — `mat_g3_na_q2_0` (money_peso), 3. KG monotonicity — `order_of_operations` introduced but not propagated, Final Definition of Done, Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02, Phase G — degenerate "estimate" pairs across all four estimate DNAs, 2026-08-04 (+7 more)
...
Cohesion: 0.06
Nodes (45): get_compatible_formatters_for_variant(), get_dnas_for_formatter(), get_formatters_for_dna(), get_supported_variants(), get_variant_curriculum_gate(), is_compatible(), is_variant_available_at(), is_variant_supported() (+37 more)
...
Cohesion: 0.07
Nodes (31): CompetencyConfiguration, get_intro_status(), get_matatag_difficulty_axes(), get_matatag_lab_interests(), get_matatag_progress(), get_node_config(), LabV2ConfigSaveRequest, LabV2GenerateRequest (+23 more)
...
Cohesion: 0.05
Nodes (54): Any, A reusable story template with named slots.      Slots are filled from the stude, Fill template with interest slots and numeric values.                  Handles s, Serialize to dict for API response., Spine, _build_symbolic_question(), _detect_axes_served(), _eval_error_formula() (+46 more)
...
## Knowledge Gaps
- **1067 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+1062 more)
...
- **Why does `FormattedProblem` connect `Community 131` to `generate_params`, `Community 4`, `Community 8`, `Community 13`, `Community 18`, `Community 153`, `Community 50`, `Community 51`, `Spine`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `compute_difficulty_scalar`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `_manifest.py`, `run_audit`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `get_all_node_ids`, `Community 99`, `Community 100`, `CompetencyConfiguration`, `Community 123`?**
...
- **Why does `DNA` connect `fmt_pictograph.py` to `Community 1`, `VisualSchemaRegistry`, `generate_params`, `Community 131`, `Community 14`, `counting.py`, `Community 24`, `Community 36`, `Community 41`, `validate_interest.py`, `mastery_drill.py`, `Native SQL Examples`, `validate_capability.py`, `fractions.py`, `counting.py`, `Community 87`, `Native SQL Examples`, `get_all_node_ids`, `Community 101`, `TestLogScaleDeclarations`, `Community 118`, `time_reading.py`, `scaffolded.py`?**
