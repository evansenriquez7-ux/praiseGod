...
## Corpus Check
- 448 files · ~653,376 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3252 nodes · 5230 edges · 258 communities (241 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ef3e7dfc`
...
Cohesion: 0.06
Nodes (48): decompose_to_places(), generate_hints(), generate_params(), max_regrouping_places(), Any, DNA: Addition (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (ar, "N is H hundreds, T tens, and O ones." (place values whose digit is 0     are om, Check if a pair satisfies regrouping difficulty based on COUNT of places.      C (+40 more)
...
Cohesion: 0.17
Nodes (19): _are_values_equal(), _eval_formula(), Any, Evaluate a formula string with values as variable bindings., Check if two math values are equal, supporting fraction strings vs float compari, count_addition_carries(), count_subtraction_borrows(), get_expected_mapped_value() (+11 more)
...
Cohesion: 0.10
Nodes (23): get_node_competency_bounds(), get_node_info(), _parse_competency_bounds(), Parse competency text to extract bounds for difficulty dimensions.      Returns, Get competency-specific bounds for a node's difficulty dimensions.          Retu, Return the full knowledge-graph node dict for a node.      Args:         node_id, _bound_restricts_to(), _content_words() (+15 more)
...
Cohesion: 0.22
Nodes (9): get_node_dnas(), get_node_formatters(), Return the list of DNA concept names for a node.      Args:         node_id: MAT, Return the union of compatible formatters from all DNAs for a node.      Looks u, PracticeOrchestrator, Any, Bridge Layer separating the generation logic from the FastAPI routing/server lay, The orchestrator must set problem.dna_name to the actually-chosen DNA. (+1 more)
...
Cohesion: 0.08
Nodes (34): interpolate(), linear_interpolate(), log_interpolate(), Compute the dimension value at difficulty scalar t.          If override_min/ove, Logarithmic interpolation between min_val and max_val at position t.      Produc, Linear interpolation between min_val and max_val at position t., Interpolate between min_val and max_val using the given scale type.      scale_t, generate_hints() (+26 more)
...
### Community 240 - "_rationale_skeleton"
Cohesion: 0.40
...
Cohesion: 0.40
Nodes (5): 2026-08-13 — Tick A: the freshness check compared the stem and nothing else, The blind spot, The derivation item's variety, on the reviewer's own measurements, The fix, Verification — the check catches what it was written for
...
Cohesion: 0.50
Nodes (4): get_variant_curriculum_gate(), is_variant_available_at(), Return the curriculum introduction point for a variant, or None if no gate., Check if a variant is available at a specific grade/quarter per curriculum.
...
## Knowledge Gaps
- **982 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+977 more)
...
- **Why does `FormattedProblem` connect `Community 4` to `Community 1`, `Community 131`, `Community 8`, `Community 13`, `Community 14`, `Community 16`, `Community 24`, `Community 153`, `Community 41`, `Community 50`, `Community 51`, `SKILL.md`, `Community 59`, `Community 60`, `Native SQL Examples`, `get_gemini_models`, `Community 70`, `get_interest_themes`, `Community 77`, `Community 79`, `_get_available_formats`, `geometric_lines.py`, `Community 92`, `Community 93`, `calendar.py`, `test_semantic_leak_guards.py`, `Community 94`, `Community 95`, `CompetencyConfiguration`, `fmt_numeric_input.py`, `Queries`, `fmt_ruler_measure.py`, `build_scaffold_sequence`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 1`, `Community 4`, `Community 13`, `Community 14`, `Community 16`, `Community 24`, `Community 153`, `Community 41`, `Community 51`, `SKILL.md`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `Community 92`, `Community 93`, `calendar.py`, `test_semantic_leak_guards.py`, `Community 94`, `Community 95`, `CompetencyConfiguration`, `fmt_numeric_input.py`, `fmt_ruler_measure.py`, `build_scaffold_sequence`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `DNA` connect `get_interest_themes` to `frontend_contract_auditor.py`, `counting.py`, `Community 1`, `Community 100`, `Community 101`, `Community 75`, `Community 14`, `Community 86`, `Community 118`, `Community 24`, `Native SQL Examples`, `Community 26`, `Part 1 — Diagnosis: how the current docs cause bugs`?**
