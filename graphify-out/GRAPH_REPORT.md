# Graph Report - ccmed  (2026-06-25)

## Corpus Check
- 143 files · ~208,188 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1397 nodes · 2652 edges · 117 communities (110 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `405eec5f`
...
Cohesion: 0.10
Nodes (17): get_matatag_difficulty_axes(), get_matatag_lab_config(), get_matatag_lab_interests(), get_matatag_progress(), matatag_lab_generate(), matatag_lab_submit(), matatag_lab_v2_submit(), Background task to pre-generate questions into the cache.     Uses parallel exec (+9 more)
...
Cohesion: 0.13
Nodes (20): _count_decimal_places(), generate_number_by_window(), generate_pair_by_window(), Choose a number randomly from the candidates list within the difficulty range wi, Choose an operand pair randomly from candidate_pairs within the difficulty range, _fraction_str(), generate_hints(), generate_params() (+12 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (31): Any, ErrorPattern, A pedagogically meaningful wrong answer.      formula:          SymPy expression, generate_hints(), generate_params(), DNA: Probability Language (Data & Probability)  Covers MATATAG grade 3 probabili, Sample one scenario from the static pool filtered by difficulty profile., build_scaffold_sequence() (+23 more)
...
Cohesion: 0.05
Nodes (58): _gen_g2_dp_q3_pictograph(), _gen_g2_mg_q1_circles(), _gen_g2_mg_q1_slides(), _gen_g2_mg_q2_measurement(), _gen_g2_mg_q4_perimeter(), _gen_g2_mg_q4_solid_figures(), _gen_g2_mg_q4_time(), _gen_g2_na_q1_addition() (+50 more)
...
Cohesion: 0.09
Nodes (22): StudentLoginRequest, TelemetrySessionStartRequest, load_matatag_curriculum_endpoint(), Load MATATAG (Philippine K-10 Math) curriculum into the skill_nodes table., get_intro_status(), get_node_config(), mark_intro_viewed(), Read the enabled checkboxes for a node. (+14 more)
...
Cohesion: 0.11
Nodes (34): get_db(), FastAPI dependency that yields a database session.     Guarantees session closur, SessionLocal(), Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache(), Translate a FormattedProblem to the legacy skeleton dict format.      This shim, to_legacy_dict(), compute_difficulty_scalar() (+26 more)
...
Cohesion: 0.40
Nodes (5): SocraticChatRequest, _combined_interests(), Socratic Tutor split-screen dialog endpoint.     Guides the student out of their, Merge parent-set interest_tags and student-set student_interest_tags into a, socratic_chat_exchange()
...
Cohesion: 0.06
Nodes (34): linear_interpolate(), A mathematical term fragment gated behind vocab knowledge.      preferred:    Te, Linear interpolation between min_val and max_val at position t., VocabGated, generate_hints(), generate_params(), DNA: Bar Graphs (Data & Probability)  Covers MATATAG grade 3 bar graph competenc, Returns visual_params for the BarChart formatter (G3 only).     {"categories": l (+26 more)

### Community 36 - "Community 36"
Cohesion: 0.10
Nodes (26): generate_intro_content(), get_available_intro_nodes(), get_interest_themes(), _get_introduction(), Intro Content Generator  Produces structured intro slides for MATATAG nodes usin, Return all interest themes. Grade parameter is ignored (kept for API compatibili, Bind the G1_NA_Q1 generator functions after they are defined., Return list of nodes that have intro content available. (+18 more)
...
Cohesion: 0.25
Nodes (8): _import_dna_module(), Dynamically import the DNA module for a given concept name.      Looks up the co, get_pipeline_status(), Return a health-check dict for the pipeline.      Checks:       - Whether each o, get_all_node_ids(), Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, get_node_capabilities(), Introspect DNA to return available axes, variants, and formatters.
...
Cohesion: 0.10
Nodes (22): A reusable story template with named slots.      Slots are filled from the stude, Fill template with interest slots and numeric values.                  Handles s, Spine, _eval_error_formula(), generate_context(), Practice Generation — Context Generator ========================================, Generate a format-agnostic QuestionContext from a DNA + node.      Steps:, Evaluate a simple arithmetic formula string using values as variables.      Only (+14 more)
...
Cohesion: 0.17
Nodes (8): Practice Generation — DNA Base Definitions  All dataclasses, enums, and shared u, is_mastered(), Practice Generation — Mastery Drill Experience Wrapper  Rapid-fire practice unti, Return an updated session state after one answer.      Correct answer  → consecu, Return True if the student has reached mastery.      Args:         session_state, update_drill_state(), Practice Generation — Scaffolded Experience Wrapper  Ascending-difficulty sequen, Practice Generation — Standard Experience Wrapper  Simple pass-through wrapper t

### Community 66 - "Community 66"
Cohesion: 0.20
Nodes (7): get_matatag_competencies(), Return MATATAG competencies for dropdown selection in Problem Lab.          Resp, _match_competency_to_visual_type(), Background task to pre-generate questions into the cache.     Uses parallel exec, Match a MATATAG competency to a visual skeleton type using regex patterns.     R, RedisDict, replenish_question_cache()
...
Cohesion: 0.38
Nodes (7): CompetencyConfiguration, PydanticBaseModel, LabV2ConfigSaveRequest, LabV2SubmitRequest, Request body for /api/matatag/lab/v2/submit, Save the enabled checkboxes for a node., save_node_config()
...
Cohesion: 0.11
Nodes (18): log_interpolate(), Logarithmic interpolation between min_val and max_val at position t.      Produc, generate_hints(), generate_params(), DNA: Mass and Capacity (Measurement & Geometry)  Covers MATATAG grade 3 mass and, Returns measurement value(s) and the answer.     For 'convert' task: produces va, generate_hints(), generate_params() (+10 more)
...
Cohesion: 0.30
Nodes (4): _combined_interests(), Merge parent-set interest_tags and student-set student_interest_tags into a, Practice Generation — Difficulty Axes Catalog ==================================, # NOTE: "structure" removed - it's a contextual variant, not a difficulty dimens
...
## Knowledge Gaps
- **161 isolated node(s):** `Config`, `name`, `private`, `version`, `type` (+156 more)
...
- **Why does `FormattedProblem` connect `Community 52` to `Community 11`, `Community 13`, `Community 22`, `Community 30`, `Community 39`, `Community 50`, `Community 51`, `Community 61`, `Community 64`, `Community 65`, `Community 69`, `Community 70`, `Community 71`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 94`, `Community 98`, `Community 105`, `Community 108`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `get_cache()` connect `Community 27` to `Community 0`, `Community 1`, `Community 66`, `Community 36`, `Community 5`, `Community 18`, `Community 22`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 30` to `Community 11`, `Community 13`, `Community 39`, `Community 48`, `Community 50`, `Community 51`, `Community 52`, `Community 54`, `Community 61`, `Community 65`, `Community 69`, `Community 70`, `Community 71`, `Community 78`, `Community 79`, `Community 80`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 98`, `Community 105`, `Community 108`?**
