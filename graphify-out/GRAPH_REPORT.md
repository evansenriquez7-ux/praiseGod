...
## Corpus Check
- 462 files · ~757,175 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3517 nodes · 5558 edges · 282 communities (267 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe6cec18`
...
## Communities (282 total, 15 thin omitted)
...
Cohesion: 0.07
Nodes (39): get_supported_variants(), Any, Return variants supported by a specific DNA + formatter combination.      Applie, Validate a lab UI selection and return compatibility info.      Args:         dn, validate_lab_selection(), get_matatag_lab_config(), Return full lab configuration for a MATATAG node.      Includes:     - difficult, _audit_node() (+31 more)
...
Cohesion: 0.13
Nodes (31): SessionLocal(), Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache(), Practice Generation — Difficulty Axes Catalog ==================================, Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache(), Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache() (+23 more)
...
Cohesion: 0.11
Nodes (25): get_node(), Return the raw knowledge-graph node dict for node_id, or None.      Args:, get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, lint_all_vocab_gated_instances(), Practice Generation — Vocabulary & Concept Constraint Validation  Verifies that, Verify that distractors don't presuppose unknown concepts.      For each distrac, Generate sample problems for a node and run vocabulary/concept checks.      Args (+17 more)
...
Cohesion: 0.17
Nodes (8): interpolate(), Any, Compute the dimension value at difficulty scalar t.          If override_min/ove, A reusable story template with named slots.      Slots are filled from the stude, Fill template with interest slots and numeric values.                  Handles s, Serialize to dict for API response., Interpolate between min_val and max_val using the given scale type.      scale_t, Spine
...
Cohesion: 0.08
Nodes (35): get_variant_curriculum_gate(), is_variant_available_at(), Return the curriculum introduction point for a variant, or None if no gate., Check if a variant is available at a specific grade/quarter per curriculum., _build_symbolic_question(), _detect_axes_served(), _eval_error_formula(), generate_context() (+27 more)
...
Cohesion: 0.15
Nodes (17): A mathematical term fragment gated behind vocab knowledge.      preferred:    Te, VocabGated, generate_hints(), generate_params(), Any, DNA: Symmetry and Slides (Measurement & Geometry)  Covers MATATAG grades 2–3 sym, Sample one item from the static pool filtered by grade, concept, and directions., _build_traps() (+9 more)
...
- **Why does `FormattedProblem` connect `models.py` to `Queries`, `generate_params`, `Community 131`, `_get_available_formats`, `Community 8`, `fmt_array_grid.py`, `generate_params`, `Community 13`, `Community 18`, `fmt_pictograph.py`, `Community 153`, `Community 25`, `Community 41`, `Community 50`, `Community 51`, `Spine`, `Native SQL Examples`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `validate_capability.py`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `Community 95`, `CompetencyConfiguration`, `Community 102`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Queries`, `generate_params`, `_get_available_formats`, `fmt_array_grid.py`, `Community 13`, `Community 18`, `fmt_pictograph.py`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `models.py`, `Community 95`, `get_all_node_ids`, `CompetencyConfiguration`, `Community 102`, `Community 117`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `DNA` connect `2026-08-14 — The blank landed on a given, not on the unknown` to `Queries`, `Community 1`, `generate_params`, `.axis_level_index`, `generate_params`, `counting.py`, `generate_params`, `Community 14`, `Community 24`, `Community 36`, `Community 41`, `validate_interest.py`, `mastery_drill.py`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `_get_available_formats`, `Community 87`, `mass_capacity.py`, `models.py`, `get_all_node_ids`, `socratic_chat_exchange`, `Community 101`, `TestLogScaleDeclarations`, `RedisDict`, `Community 117`, `generate_params`, `Community 118`, `Part 3 — Concrete restructuring of the current docs/`, `Community 123`?**
