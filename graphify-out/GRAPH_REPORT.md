...
## Corpus Check
- 470 files · ~770,256 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3547 nodes · 5590 edges · 281 communities (267 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e7b24e6f`
...
3. `DNA` - 57 edges
4. `Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02` - 57 edges
...
Cohesion: 0.10
Nodes (29): Translate a FormattedProblem to the legacy skeleton dict format.      This shim, to_legacy_dict(), _audit_node(), build_test_profiles(), _check_cap_vs_formatter_code(), check_checklist_compliance(), _check_variant_sensitivity(), _check_visual_capacity() (+21 more)
...
Cohesion: 0.05
Nodes (62): is_variant_available_at(), Check if a variant is available at a specific grade/quarter per curriculum., enumerate_profiles(), Return every combination of difficulty axis levels for a DNA.      Iterates over, Any, Registry to map visual types to their Pydantic schemas., VisualSchemaRegistry, _parse_contract_section_refs() (+54 more)
...
Cohesion: 0.12
Nodes (14): get_dnas_for_formatter(), get_supported_variants(), get_variant_curriculum_gate(), get_variants_for_dna(), is_compatible(), Any, Practice Generation — DNA-Formatter Compatibility Table ========================, Return all contextual variants defined for a DNA concept.      Args:         dna (+6 more)
...
Cohesion: 0.08
Nodes (40): _build_symbolic_question(), _detect_axes_served(), _eval_error_formula(), generate_context(), get_node(), _import_dna_module(), Any, Practice Generation — Context Generator ======================================== (+32 more)
...
Cohesion: 0.13
Nodes (12): interpolate(), Any, Compute the dimension value at difficulty scalar t.          If override_min/ove, A reusable story template with named slots.      Slots are filled from the stude, Fill template with interest slots and numeric values.                  Handles s, Serialize to dict for API response., Interpolate between min_val and max_val using the given scale type.      scale_t, Spine (+4 more)
...
Cohesion: 0.22
Nodes (9): get_formatters_for_dna(), Return all formatter names compatible with a given DNA concept.      Args:, PracticeOrchestrator, Any, Bridge Layer separating the generation logic from the FastAPI routing/server lay, The orchestrator must set problem.dna_name to the actually-chosen DNA., The cross-DNA formatter filter, asserted as an INVARIANT over every case where, The complementary case: when the formatter IS offered by the node's own DNA, (+1 more)
...
## Knowledge Gaps
- **1139 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+1134 more)
...
- **Why does `FormattedProblem` connect `Community 41` to `generate_params`, `Community 4`, `_get_available_formats`, `.axis_level_index`, `generate_params`, `Community 8`, `fmt_array_grid.py`, `generate_params`, `generate_params`, `Community 13`, `Community 18`, `_combined_interests`, `Community 153`, `Community 25`, `_get_available_formats`, `Community 50`, `Community 51`, `Spine`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `models.py`, `Community 95`, `CompetencyConfiguration`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `generate_params`, `_get_available_formats`, `.axis_level_index`, `generate_params`, `generate_params`, `Community 13`, `Community 18`, `_combined_interests`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `models.py`, `Community 95`, `CompetencyConfiguration`, `Community 117`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `DNA` connect `generate_params` to `Community 131`, `Community 36`, `Community 101`, `Community 102`, `Community 123`, `Community 11`, `Community 14`, `_get_available_formats`, `Community 117`, `Community 118`, `validate_interest.py`, `Community 24`, `Native SQL Examples`, `generator.py`, `mass_capacity.py`?**
