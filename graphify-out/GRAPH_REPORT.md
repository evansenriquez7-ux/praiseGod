...
## Corpus Check
- 448 files · ~657,017 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3270 nodes · 5248 edges · 255 communities (244 shown, 11 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ff7c93da`
...
Cohesion: 0.05
Nodes (60): _fraction_str(), _fraction_words(), generate_hints(), generate_params(), Any, DNA: Fractions (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (f, Spell out a fraction in words, e.g. (3, 4) -> 'three fourths'., Rejection-sample a fraction (or pair of fractions) matching difficulty_profile. (+52 more)
...
Cohesion: 0.10
Nodes (23): Practice Generation — Validation Manifest  Central source of truth for the valid, _parse_contract_section_refs(), Practice Generation — Validation Harness Runner  Runs all validators in the prac, Extract every '§1A'-style reference from docs/pgen_contract.md's rule     table, run_all(), Practice Generation — Compatibility & Registry Coverage Validation  Verifies tha, Integrity lint check asserting that along every prerequisite edge:     successor, Assert that the Lab router's bridge scalar is dynamically linked to the portal's (+15 more)
...
Cohesion: 0.08
Nodes (31): Any, Practice Generation — Pipeline Coordinator =====================================, Generate a single practice problem and return it as a dict.      This is the sin, Generate a batch of varied practice problems and return them as dicts.      Args, run(), run_batch(), find_node_id(), get_node_formatters() (+23 more)
...
Cohesion: 0.08
Nodes (41): CompetencyConfiguration, _combined_interests(), _get_available_formats(), get_intro_content(), get_intro_status(), get_matatag_difficulty_axes(), get_matatag_lab_interests(), get_matatag_nodes() (+33 more)
...
Cohesion: 0.25
Nodes (8): _content_words(), Lowercased alphanumeric tokens of `text`, minus function words., §6A — a clause the competency does not contain is invented, not declared., §6B — a competency word no clause covers is a requirement silently dropped., Run §6A/§6B/§6C over every registered node. Returns a flat list of failures., validate_capability_declarations(), _validate_coverage(), _validate_provenance()
...
Cohesion: 0.14
Nodes (19): get_node_competency_bounds(), Get competency-specific bounds for a node's difficulty dimensions.          Retu, Sorted (variant_name, value) pairs worth demonstrating at least once:     every, _variant_coverage_candidates(), _bound_restricts_to(), _provided_for_node(), Any, Practice Generation — Capability Contract Validator (§6)  The problem this solve (+11 more)
...
Cohesion: 0.29
Nodes (5): get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, Mechanical triage for co-mapped-DNA bleed: for every FAIL/CONCERN node mapped to, Quoting the node's own MATATAG competency is legitimate, not fabrication., test_competency_text_may_be_quoted()
...
## Knowledge Gaps
- **997 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+992 more)
...
- **Why does `FormattedProblem` connect `Community 4` to `build_scaffold_sequence`, `Community 11`, `Community 13`, `Community 16`, `Community 24`, `Community 153`, `Community 41`, `Community 50`, `Community 51`, `Spine`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `CompetencyConfiguration`, `time_reading.py`, `Community 92`, `Community 93`, `calendar.py`, `fmt_bar_chart.py`, `Community 95`, `CompetencyConfiguration`, `Community 104`, `fmt_ruler_measure.py`, `grader_roundtrip_auditor.py`, `Community 123`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 4`, `Community 11`, `Community 13`, `Community 16`, `Community 24`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `generator.py`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `time_reading.py`, `Community 92`, `Community 93`, `calendar.py`, `fmt_bar_chart.py`, `Community 95`, `CompetencyConfiguration`, `fmt_ruler_measure.py`, `grader_roundtrip_auditor.py`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `DNA` connect `Community 24` to `frontend_contract_auditor.py`, `counting.py`, `Community 4`, `Community 101`, `Community 36`, `counting.py`, `build_scaffold_sequence`, `Community 75`, `get_interest_themes`, `generator.py`, `Community 14`, `Community 86`, `Community 118`, `Community 26`, `Part 1 — Diagnosis: how the current docs cause bugs`, `_are_values_equal`?**
