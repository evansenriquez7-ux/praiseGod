...
## Corpus Check
- 262 files · ~305,119 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2796 nodes · 4445 edges · 207 communities (191 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a5698c8a`
...
Cohesion: 0.05
Nodes (62): DimensionSpec, DNA, ErrorPattern, extract_continuous_scalar(), extract_discrete_level(), linear_interpolate(), Practice Generation — DNA Base Definitions  All dataclasses, enums, and shared u, A pedagogically meaningful wrong answer.      formula:          SymPy expression (+54 more)
...
Cohesion: 0.14
Nodes (23): CompetencyConfiguration, Generate a single practice problem and return it as a dict.      This is the sin, run(), _all_node_ids(), _audit_node(), check_payload(), _leak_keys_for(), main() (+15 more)
...
Cohesion: 0.06
Nodes (50): get_dnas_for_formatter(), get_formatters_for_dna(), get_supported_variants(), get_variant_curriculum_gate(), get_variants_for_dna(), is_compatible(), is_variant_available_at(), is_variant_supported() (+42 more)
...
Cohesion: 0.07
Nodes (35): _build_pure_equation(), _distractor_label(), _distractor_value(), format_error_detect(), _pick_actor(), Any, Random, Textual Formatter — Error Detection ("Check the Work")  Presents a worked proble (+27 more)
...
Cohesion: 0.11
Nodes (23): log_interpolate(), Logarithmic interpolation between min_val and max_val at position t.      Produc, generate_hints(), generate_params(), Any, Returns measurement value(s) and the answer.     For 'convert' task: produces va, _close_pair(), _compare_symbol() (+15 more)
...
Cohesion: 0.10
Nodes (26): QuestionContext, Format-agnostic intermediate produced by the context generator.      Everything, _build_equation_sentence(), format_cloze(), Random, Textual Formatter — Cloze (Fill-in-the-Blank)  Unified formatter for fill-in-the, Build pure equation with blank based on concept and blank_target., Format a QuestionContext as a cloze (fill-in-the-blank) problem.      Respects t (+18 more)

### Community 100 - "Community 100"
Cohesion: 0.16
Nodes (14): generate_hints(), generate_params(), Any, DNA: Multiplication (Number & Algebra)  Refactored from:   - matatag_skeletons.p, Rejection-sample (a, b) that satisfy the difficulty_profile constraints.      Re, Return 2–4 step-by-step hint strings for the given multiplication problem., Return the allowed factor-b values for the given table axis level.      Includes, _satisfies_number_type() (+6 more)
...
Cohesion: 0.13
Nodes (13): get_pipeline_status(), Any, Return a health-check dict for the pipeline.      Checks:       - Whether each o, find_node_id(), get_all_node_ids(), get_node_formatters(), _parse_competency_bounds(), Practice Generation — Node Registry ======================================  Maps (+5 more)
...
## Knowledge Gaps
- **825 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+820 more)
...
- **Why does `QuestionContext` connect `Community 99` to `Community 3`, `Community 4`, `Community 13`, `Community 14`, `Community 41`, `Community 50`, `Community 51`, `SKILL.md`, `Community 59`, `Community 60`, `Community 70`, `Community 77`, `Community 78`, `Community 79`, `Community 90`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 104`, `Community 118`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `FormattedProblem` connect `Community 4` to `Community 13`, `Community 14`, `Community 17`, `Community 24`, `Community 41`, `Community 50`, `Community 51`, `SKILL.md`, `Community 59`, `Community 60`, `Community 70`, `Community 77`, `Community 78`, `Community 79`, `Community 90`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 99`, `Community 104`, `Community 118`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `DNA` connect `Community 14` to `counting.py`, `Community 3`, `Community 4`, `Community 100`, `Community 101`, `Community 75`, `Community 11`, `Community 18`, `Community 86`, `validate_interest.py`, `Community 26`?**
