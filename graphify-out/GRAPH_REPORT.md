...
## Corpus Check
- 462 files · ~755,408 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3512 nodes · 5549 edges · 288 communities (264 shown, 24 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e3ab8b50`
...
Cohesion: 0.06
Nodes (45): Translate a FormattedProblem to the legacy skeleton dict format.      This shim, to_legacy_dict(), get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, get_matatag_lab_config(), Return full lab configuration for a MATATAG node.      Includes:     - difficult, _audit_node(), build_test_profiles() (+37 more)
...
Cohesion: 0.09
Nodes (19): Mutation tests for the capability contract (§6A/§6B/§6C).  These exist because g, The discrimination must key on *what survives removing the family*, never on how, §6F must clear once a verdict is on file, or it is a counter rather than a check, There is no 'partly provided'. A malformed record is loud, never skipped., An attestation is evidence about specific rendered content and stops being evide, A requirement the curriculum never states cannot be declared., A `bounds` list carried verbatim by most of the table claims nothing.      Measu, Ignoring a competency word is possible but visible -- never a silent default. (+11 more)
...
Cohesion: 0.07
Nodes (44): get_node(), Return the raw knowledge-graph node dict for node_id, or None.      Args:, get_all_node_ids(), get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, _attestation_records(), _attestation_staleness() (+36 more)
...
Cohesion: 0.22
Nodes (10): _numeric_payload_values(), _profile_echo_keys(), Any, Every `given_values` key that is an echo of the request rather than generated, Every plain number a generated problem exposes to the student, labelled for, Score the complexity of whole numbers/fractions in problem.given_values., score_problem_operands(), test_numeric_payload_skips_booleans_and_collects_nested() (+2 more)
...
Cohesion: 0.13
Nodes (22): interpolate(), Compute the dimension value at difficulty scalar t.          If override_min/ove, Interpolate between min_val and max_val using the given scale type.      scale_t, enumerate_profiles(), extract_numerical_limits(), get_dimension_ranges(), _make_predicates(), measure_acceptance_rate() (+14 more)
...
Cohesion: 0.40
Nodes (5): 2026-08-20 (tick 5) — §6E shipped, and the read_mcq programme scoped before it is started, §6E — the last mechanical wildcard, open for five ticks, Finding: two unit tests are red on HEAD and the loop cannot see it, The dormant branch, and why it is still tested, The read_mcq programme, scoped before starting it
...
## Knowledge Gaps
- **1114 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+1109 more)
...
- **Why does `FormattedProblem` connect `models.py` to `Queries`, `generate_params`, `Community 4`, `Community 8`, `fmt_array_grid.py`, `Community 13`, `Community 18`, `fmt_pictograph.py`, `Community 153`, `Community 25`, `Community 41`, `Community 50`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `validate_capability.py`, `get_gemini_models`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `Community 95`, `CompetencyConfiguration`, `Community 100`, `Community 102`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Queries`, `generate_params`, `fmt_array_grid.py`, `Community 13`, `Community 18`, `fmt_pictograph.py`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `get_gemini_models`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `models.py`, `Community 95`, `get_all_node_ids`, `CompetencyConfiguration`, `Community 100`, `Community 102`, `Community 104`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `DNA` connect `generate_params` to `Community 1`, `.axis_level_index`, `counting.py`, `Community 11`, `Community 14`, `test_regrouping_feasibility.py`, `build_scaffold_sequence`, `Community 24`, `Community 36`, `validate_interest.py`, `get_interest_themes`, `mass_capacity.py`, `models.py`, `get_all_node_ids`, `socratic_chat_exchange`, `Community 101`, `Community 104`, `Community 117`, `Community 118`?**
