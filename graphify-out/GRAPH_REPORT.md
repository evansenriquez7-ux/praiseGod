...
## Corpus Check
- 448 files · ~650,284 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3231 nodes · 5204 edges · 255 communities (239 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `10720dcb`
...
## Communities (255 total, 16 thin omitted)
...
Cohesion: 0.09
Nodes (30): get_variants_for_dna(), is_variant_available_at(), Return all contextual variants defined for a DNA concept.      Args:         dna, Check if a variant is available at a specific grade/quarter per curriculum., _build_symbolic_question(), _detect_axes_served(), _eval_error_formula(), generate_context() (+22 more)
...
Cohesion: 0.12
Nodes (23): decompose_to_places(), "N is H hundreds, T tens, and O ones." (place values whose digit is 0     are om, _build_equation_sentence(), format_cloze(), Random, Textual Formatter — Cloze (Fill-in-the-Blank)  Unified formatter for fill-in-the, Format a QuestionContext as a cloze (fill-in-the-blank) problem.      Respects t, Build pure equation with blank based on concept and blank_target. (+15 more)
...
Cohesion: 0.23
Nodes (17): _bound_allows(), build_group(), build_packet(), _main(), _max_difficulty_profile(), Any, Practice Generation — Blind Judgment Review Packets  Builds the data a *blind* r, Generate one problem and reduce it to reviewer-facing rendered fields only. (+9 more)
...
Cohesion: 0.06
Nodes (52): Attempt, CompetencyConfiguration, MasteryState, NodeIntroView, ParentAccount, QuestionFlag, SkillEdge, SkillNode (+44 more)
...
Cohesion: 0.19
Nodes (12): generate_hints(), generate_params(), Any, DNA: Multiplication (Number & Algebra)  Refactored from:   - matatag_skeletons.p, Return the allowed factor-b values for the given table axis level.      A recogn, Rejection-sample (a, b) that satisfy the difficulty_profile constraints.      Re, Return 2–4 step-by-step hint strings for the given multiplication problem., _satisfies_number_type() (+4 more)
...
Cohesion: 0.09
Nodes (36): get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, get_node_competency_bounds(), _parse_competency_bounds(), Parse competency text to extract bounds for difficulty dimensions.      Returns, Get competency-specific bounds for a node's difficulty dimensions.          Retu, _are_values_equal(), _eval_formula() (+28 more)
...
Cohesion: 0.11
Nodes (24): linear_interpolate(), Linear interpolation between min_val and max_val at position t., generate_hints(), generate_params(), Any, Random, DNA: Area (Measurement & Geometry)  Covers MATATAG grade 3 area competencies onl, Returns side dimensions and the area answer.     For find_missing_dimension task (+16 more)
...
Cohesion: 0.25
Nodes (7): get_all_node_ids(), get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, Run run_vocab_audit for every node in the knowledge graph (full-node mode),, run_all_vocab_audits(), Mechanical triage for co-mapped-DNA bleed: for every FAIL/CONCERN node mapped to
...
## Knowledge Gaps
- **970 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+965 more)
...
- **Why does `FormattedProblem` connect `test_semantic_leak_guards.py` to `Community 4`, `Community 8`, `Community 13`, `Community 16`, `Community 24`, `Community 153`, `Community 25`, `Community 41`, `Community 50`, `Community 51`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `Community 92`, `Community 93`, `calendar.py`, `.axis_level_index`, `frontend_contract_auditor.py`, `fmt_bar_chart.py`, `Community 94`, `Community 99`, `CompetencyConfiguration`, `Community 95`, `fmt_numeric_input.py`, `run`, `build_scaffold_sequence`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 1`, `Community 4`, `Community 13`, `Community 16`, `Community 24`, `Community 153`, `Community 41`, `Community 51`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `get_engine`, `Community 77`, `Community 79`, `_get_available_formats`, `Community 92`, `Community 93`, `calendar.py`, `test_semantic_leak_guards.py`, `frontend_contract_auditor.py`, `Community 94`, `Community 95`, `CompetencyConfiguration`, `fmt_numeric_input.py`, `run`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `DNA` connect `Community 11` to `Community 1`, `Community 3`, `Community 131`, `Community 24`, `Community 26`, `SKILL.md`, `mastery_drill.py`, `Native SQL Examples`, `counting.py`, `get_engine`, `Community 75`, `get_interest_themes`, `Community 86`, `Community 87`, `Part 1 — Diagnosis: how the current docs cause bugs`, `CompetencyConfiguration`, `Community 100`, `Community 101`, `Queries`, `Community 104`, `run`, `Community 118`, `generate_params`, `generate_params`, `build_scaffold_sequence`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
