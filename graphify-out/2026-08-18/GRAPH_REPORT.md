...
## Corpus Check
- 462 files · ~696,985 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3374 nodes · 5380 edges · 264 communities (251 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1e4d9ec0`
...
### Community 248 - "2026-08-13 — The G1 measure items: a visual for the task, and a size model for the units"
Cohesion: 0.50
...
- **Why does `DNA` connect `generate_params` to `fmt_fill_in_table.py`, `Community 131`, `Community 11`, `counting.py`, `Community 24`, `validate_interest.py`, `Native SQL Examples`, `generator.py`, `_are_values_equal`, `counting.py`, `test_answer_leak_and_reach.py`, `Community 75`, `Community 78`, `CompetencyConfiguration`, `test_semantic_leak_guards.py`, `Community 94`, `Community 101`, `TestLogScaleDeclarations`, `_combined_interests`, `Community 118`?**
