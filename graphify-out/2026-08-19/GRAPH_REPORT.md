...
## Corpus Check
- 450 files · ~720,050 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3358 nodes · 5352 edges · 261 communities (252 shown, 9 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e95e455f`
...
5. `Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02` - 38 edges
...
## Communities (261 total, 9 thin omitted)
...
Cohesion: 0.13
Nodes (12): get_dnas_for_formatter(), get_variant_curriculum_gate(), is_compatible(), is_variant_available_at(), Any, Practice Generation — DNA-Formatter Compatibility Table ========================, Validate a lab UI selection and return compatibility info.      Args:         dn, Return the curriculum introduction point for a variant, or None if no gate. (+4 more)
...
Cohesion: 0.06
Nodes (50): interpolate(), linear_interpolate(), log_interpolate(), Practice Generation — DNA Base Definitions  All dataclasses, enums, and shared u, Logarithmic interpolation between min_val and max_val at position t.      Produc, Linear interpolation between min_val and max_val at position t., Interpolate between min_val and max_val using the given scale type.      scale_t, generate_hints() (+42 more)
...
Cohesion: 0.06
Nodes (39): Any, Generate a single practice problem and return it as a dict.      This is the sin, Generate a batch of varied practice problems and return them as dicts.      Args, run(), run_batch(), find_node_id(), get_node_competency_bounds(), _parse_competency_bounds() (+31 more)
...
Cohesion: 0.09
Nodes (32): Any, Registry to map visual types to their Pydantic schemas., VisualSchemaRegistry, _parse_contract_section_refs(), Practice Generation — Validation Harness Runner  Runs all validators in the prac, Extract every '§1A'-style reference from docs/pgen_contract.md's rule     table, run_all(), count_addition_carries() (+24 more)
...
Cohesion: 0.10
Nodes (18): get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, get_matatag_lab_config(), Return full lab configuration for a MATATAG node.      Includes:     - difficult, _continuous_axes_with_default_range(), Tests for the axes-catalog logarithmic scale and the auditor's ``build_test_prof, ``build_test_profiles`` must include every config-declared     contextual-varian, Yield (concept, axis) for every continuous axis that has both     default_min an (+10 more)
...
Cohesion: 0.14
Nodes (14): DimensionSpec, Compute the dimension value at difficulty scalar t.          If override_min/ove, Specification for a single difficulty dimension.      Defines how a dimension sc, DNA: Addition (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (ar, # NOTE: "structure" is a contextual variant, not a difficulty dimension., generate_hints(), generate_params(), Any (+6 more)
...
Cohesion: 0.14
Nodes (18): _build_symbolic_question(), _detect_axes_served(), _eval_error_formula(), Any, Practice Generation — Context Generator ========================================, Back-infer which difficulty axis levels were actually produced.      Checks the, Evaluate a simple arithmetic formula string using values as variables.      Only, Build a plain symbolic question string for non-context DNAs.      Uses VocabGate (+10 more)
...
## Knowledge Gaps
- **1049 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+1044 more)
...
- **Why does `FormattedProblem` connect `Community 131` to `Community 8`, `Community 138`, `Community 13`, `Community 18`, `Community 24`, `Community 153`, `Community 25`, `Community 50`, `Community 51`, `1. Local Prototyping: Data Seeding`, `Community 59`, `Community 60`, `validate_capability.py`, `get_gemini_models`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `run_audit`, `Community 92`, `Community 93`, `Native SQL Examples`, `Community 94`, `Community 95`, `Community 100`, `CompetencyConfiguration`, `Community 102`, `fmt_pictograph.py`, `_combined_interests`, `mastery_drill.py`, `scaffolded.py`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `DNA` connect `validate_interest.py` to `fmt_fill_in_table.py`, `generate_params`, `Community 131`, `Community 14`, `counting.py`, `Community 24`, `Community 26`, `Community 41`, `mastery_drill.py`, `Native SQL Examples`, `fractions.py`, `counting.py`, `test_semantic_leak_guards.py`, `Community 87`, `Native SQL Examples`, `models.py`, `fmt_numeric_input.py`, `get_all_node_ids`, `Community 101`, `TestLogScaleDeclarations`, `health`, `symmetry_slides.py`, `Community 118`, `time_reading.py`, `scaffolded.py`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 131`, `Community 138`, `Community 13`, `Community 18`, `Community 24`, `Community 153`, `Community 41`, `Community 51`, `Community 59`, `Community 60`, `validate_capability.py`, `get_gemini_models`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `run_audit`, `Community 92`, `Community 93`, `Native SQL Examples`, `Community 94`, `Community 95`, `get_all_node_ids`, `Community 100`, `CompetencyConfiguration`, `fmt_pictograph.py`?**
