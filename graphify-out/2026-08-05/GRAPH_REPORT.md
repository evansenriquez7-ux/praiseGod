...
Cohesion: 0.05
Nodes (56): get_variant_curriculum_gate(), get_variants_for_dna(), is_variant_available_at(), Return the curriculum introduction point for a variant, or None if no gate., Check if a variant is available at a specific grade/quarter per curriculum., Return all contextual variants defined for a DNA concept.      Args:         dna, A reusable story template with named slots.      Slots are filled from the stude, Spine (+48 more)
...
Cohesion: 0.10
Nodes (41): get_db(), FastAPI dependency that yields a database session.     Guarantees session closur, SessionLocal(), Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache(), get_axes_for_concept(), Return the UI-ready axis list for a concept, or [] if not found., Practice Generation — Pipeline Coordinator ===================================== (+33 more)
...
Cohesion: 0.10
Nodes (19): Access Levels, Anti-Patterns, @auth Directive, auth.token Fields, Authorization Data Lookup, Available Bindings, CEL Expressions, @check (+11 more)
...
Cohesion: 0.14
Nodes (13): 1. Fractions answer-key false positive — `mat_g2_na_q4_0`/`_1`/`_2`, 2026-07-27 — Track 1: converting judgment debt into enforcement, 2. `§1A-reach` false failure — `mat_g3_na_q2_0` (money_peso), 3. KG monotonicity — `order_of_operations` introduced but not propagated, Bug 1 — my own array_grid alias collided with a pre-existing, differently-scoped alias, Bug 2 — error_detect never handled a non-result blank_target, pre-existing, Final Definition of Done, Final state (RED, itemised) (+5 more)
...
Cohesion: 0.09
Nodes (31): generate_hints(), generate_params(), max_regrouping_places(), Any, DNA: Addition (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (ar, Check if a pair satisfies regrouping difficulty based on COUNT of places.      C, Largest carry count physically achievable for any (a, b) with a + b <= max_resul, True if `level` can be satisfied by some (a, b) with a + b <= max_result. (+23 more)
...
Cohesion: 0.10
Nodes (30): get_all_node_ids(), get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, build_group(), build_packet(), _main(), Any (+22 more)

### Community 191 - "Native SQL Examples"
Cohesion: 0.14
Nodes (23): _parse_contract_section_refs(), Practice Generation — Validation Harness Runner  Runs all validators in the prac, Extract every '§1A'-style reference from docs/pgen_contract.md's rule     table, run_all(), count_addition_carries(), count_subtraction_borrows(), get_expected_mapped_value(), get_variant_combinations() (+15 more)
...
Cohesion: 0.14
Nodes (14): Categorized Bugs Identified by Phase 1, Dispatching blind review (6 batches, ~26 nodes each) + verifying they stayed blind, Final state, Finding the judgment layer was hollow, Generating real samples for genuine review — and a methodology bug found along the way, Ground-truth test-fixture corrections (Ground Rule 2), Hardening Evidence Log, Implementation Details: (+6 more)
...
### Community 222 - "IMPLEMENTATION_STATUS.md"
Cohesion: 0.50
...
- **Why does `FormattedProblem` connect `Community 4` to `Community 8`, `Community 13`, `Community 14`, `Community 153`, `Community 41`, `Community 50`, `Community 51`, `Spine`, `SKILL.md`, `find_node_id`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `fmt_ordering.py`, `Community 70`, `Community 77`, `Community 78`, `Community 79`, `Community 90`, `Part 1 — Diagnosis: how the current docs cause bugs`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 99`, `Community 103`, `Community 104`, `Community 118`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 1`, `Community 4`, `Community 13`, `Community 14`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `SKILL.md`, `Community 59`, `Community 60`, `get_gemini_models`, `fmt_ordering.py`, `Community 70`, `Community 77`, `Community 78`, `Community 79`, `Community 90`, `Part 1 — Diagnosis: how the current docs cause bugs`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 99`, `Community 104`, `Community 118`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `get_available_intro_nodes()` connect `Community 0` to `Community 8`?**
