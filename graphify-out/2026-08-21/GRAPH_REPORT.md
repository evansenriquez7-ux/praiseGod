...
## Corpus Check
- 470 files · ~771,896 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3559 nodes · 5607 edges · 295 communities (283 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `51b2951d`
...
3. `Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02` - 59 edges
4. `DNA` - 57 edges
...
## Communities (295 total, 12 thin omitted)
...
Cohesion: 0.08
Nodes (25): 1. Fractions answer-key false positive — `mat_g2_na_q4_0`/`_1`/`_2`, 2026-08-13 — length_measurement: the largest FAIL cluster in the tree, 2026-08-14 — "2-digit by 1-digit" bounds two operands, and only one had a key, 2026-08-19 — Unit 3 completion + full `run_all` verification, 2026-08-20 (tick 7) — The harness now runs its own tests, 2026-08-20 (tick 8) — A dispatch-only tick: coverage 52 → 127, 2. `§1A-reach` false failure — `mat_g3_na_q2_0` (money_peso), 3. KG monotonicity — `order_of_operations` introduced but not propagated (+17 more)
...
Cohesion: 0.09
Nodes (31): _build_symbolic_question(), _detect_axes_served(), _eval_error_formula(), generate_context(), _import_dna_module(), Any, Practice Generation — Context Generator ========================================, Generate a format-agnostic QuestionContext from a DNA + node.      Steps: (+23 more)
...
Cohesion: 0.08
Nodes (31): log_interpolate(), Logarithmic interpolation between min_val and max_val at position t.      Produc, generate_hints(), generate_params(), _inverse_op(), Any, DNA: Missing Number (Number & Algebra)  Covers MATATAG grades 1–3 missing-number, Rejection-sample a missing-number equation matching difficulty_profile.      Ret (+23 more)
...
Cohesion: 0.10
Nodes (22): get_node_competency_bounds(), get_node_dnas(), _parse_competency_bounds(), Parse competency text to extract bounds for difficulty dimensions.      Returns, Get competency-specific bounds for a node's difficulty dimensions.          Retu, Return the list of DNA concept names for a node.      Args:         node_id: MAT, Sorted (variant_name, value) pairs worth demonstrating at least once:     every, _variant_coverage_candidates() (+14 more)
...
## Knowledge Gaps
- **1147 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+1142 more)
...
- **Why does `FormattedProblem` connect `Community 41` to `generate_params`, `_get_available_formats`, `.axis_level_index`, `generate_params`, `fmt_array_grid.py`, `Community 138`, `generate_params`, `Community 13`, `fmt_ruler_measure.py`, `Community 18`, `Community 153`, `Community 50`, `Community 51`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `Community 92`, `Community 93`, `models.py`, `Community 95`, `fmt_numeric_input.py`, `CompetencyConfiguration`, `TestLogScaleDeclarations`, `RedisDict`, `_get_available_formats`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `generate_params`, `_get_available_formats`, `.axis_level_index`, `generate_params`, `generate_params`, `Community 13`, `fmt_ruler_measure.py`, `Community 18`, `Community 153`, `Community 41`, `Community 51`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `models.py`, `Community 95`, `CompetencyConfiguration`, `TestLogScaleDeclarations`, `RedisDict`, `Community 117`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `DNA` connect `generate_params` to `Community 1`, `Community 131`, `Community 14`, `test_regrouping_feasibility.py`, `grader_roundtrip_auditor.py`, `Community 24`, `Community 36`, `build_scaffold_sequence`, `Community 41`, `validate_interest.py`, `generator.py`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `get_interest_themes`, `Community 78`, `mass_capacity.py`, `Community 101`, `Community 102`, `Community 117`, `Community 118`, `Community 123`?**
