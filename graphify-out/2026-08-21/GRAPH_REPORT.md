...
## Corpus Check
- 470 files · ~770,884 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3552 nodes · 5595 edges · 295 communities (279 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7230b41f`
...
3. `Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02` - 58 edges
4. `DNA` - 57 edges
...
## Communities (295 total, 16 thin omitted)
...
Cohesion: 0.07
Nodes (38): get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, get_node_dnas(), Return the list of DNA concept names for a node.      Args:         node_id: MAT, get_matatag_lab_config(), Return full lab configuration for a MATATAG node.      Includes:     - difficult, _audit_node(), build_test_profiles() (+30 more)
...
Cohesion: 0.14
Nodes (23): count_addition_carries(), count_subtraction_borrows(), get_expected_mapped_value(), get_variant_combinations(), main(), Any, validate_matrix.py  Executes the full behavioral matrix for every node in the MA, Top-level worker so multiprocessing can pickle it. (+15 more)
...
Cohesion: 0.08
Nodes (44): apply_experience(), apply_formatter(), generate_batch(), generate_problem(), _get_dna_instance(), Any, Random, Practice Generation — API Adapter ===================================  Main entr (+36 more)
...
Cohesion: 0.06
Nodes (34): get_dnas_for_formatter(), get_variant_curriculum_gate(), is_compatible(), Any, Practice Generation — DNA-Formatter Compatibility Table ========================, Validate a lab UI selection and return compatibility info.      Args:         dn, Return the curriculum introduction point for a variant, or None if no gate., Return True if the formatter is compatible with the given DNA concept.      Args (+26 more)
...
Cohesion: 0.09
Nodes (19): DNA, Specification of a mathematical concept for practice generation.      dna_type:, Return param_bounds for grade, falling back to nearest defined grade., Return the index of a level within an axis (0 = easiest)., Return a 0.0–1.0 scalar for a given axis level., generate_hints(), generate_params(), Any (+11 more)
...
Cohesion: 0.08
Nodes (26): §0 census at the time of this unit (all figures re-derived, none inherited), 1. Fractions answer-key false positive — `mat_g2_na_q4_0`/`_1`/`_2`, (1) `tests/unit/test_capability_contract.py::test_unprovided_capability_names_the_node_and_the_clause`, 2026-08-13 — The G1 measure items: a visual for the task, and a size model for the units, 2026-08-19 — Hardening Unit 1: restore two weakened tests (deliberate documented red), 2026-08-19 — Unit 3 completion + full `run_all` verification, 2026-08-20 — §5 worker death: a silent unbounded wait in the last gate, 2026-08-20 (tick 8) — A dispatch-only tick: coverage 52 → 127 (+18 more)
...
Cohesion: 0.09
Nodes (33): get_variants_for_dna(), is_variant_available_at(), Return all contextual variants defined for a DNA concept.      Args:         dna, Check if a variant is available at a specific grade/quarter per curriculum., _build_symbolic_question(), _detect_axes_served(), _eval_error_formula(), generate_context() (+25 more)
...
Cohesion: 0.12
Nodes (13): get_node_formatters(), Return the union of compatible formatters from all DNAs for a node.      Looks u, PracticeOrchestrator, Bridge Layer separating the generation logic from the FastAPI routing/server lay, formatter_supports_profile(), Mirror the orchestrator's per-DNA×formatter compatibility check     (backend/app, test_formatter_supports_profile.py =================================== Regressio, The orchestrator must set problem.dna_name to the actually-chosen DNA. (+5 more)
...
Cohesion: 0.24
Nodes (13): CompetencyConfiguration, _all_node_ids(), _audit_node(), check_payload(), _leak_keys_for(), main(), _parse_fraction_str(), Any (+5 more)
...
Cohesion: 0.25
Nodes (11): _are_values_equal(), _eval_formula(), Any, Validate an algorithmic-type DNA for structural correctness.     Similar to vali, Call the DNA module's generate_params with a neutral profile.     Returns the pa, Evaluate a formula string with values as variable bindings., Check if two math values are equal, supporting fraction strings vs float compari, Validate a formula-type DNA for structural correctness.      Checks:       1. an (+3 more)
...
Cohesion: 0.25
Nodes (8): load_dna(), Import the DNA module and return its DNA instance.     Raises ImportError if loa, Validate a visual_read-type DNA.      Checks:       1. answer_formula is None., Validate a static_bank-type DNA.      Checks:       1. answer_formula is None., Import and validate all 27 DNA instances.      Dispatches each DNA to the approp, validate_all_dnas(), validate_static_bank_dna(), validate_visual_dna()
...
## Knowledge Gaps
- **1143 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+1138 more)
...
- **Why does `FormattedProblem` connect `Community 41` to `generate_params`, `_get_available_formats`, `.axis_level_index`, `generate_params`, `Community 8`, `fmt_array_grid.py`, `Community 138`, `generate_params`, `Community 13`, `fmt_ruler_measure.py`, `Community 18`, `Community 153`, `Community 50`, `Community 51`, `Spine`, `Native SQL Examples`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `models.py`, `Community 95`, `Community 100`, `CompetencyConfiguration`, `2026-08-19 — Hardening Unit 1: restore two weakened tests (deliberate documented red)`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `generate_params`, `_get_available_formats`, `.axis_level_index`, `generate_params`, `generate_params`, `Community 13`, `fmt_ruler_measure.py`, `Community 18`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `models.py`, `Community 95`, `CompetencyConfiguration`, `Community 117`, `2026-08-19 — Hardening Unit 1: restore two weakened tests (deliberate documented red)`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `DNA` connect `Community 100` to `Community 1`, `generate_params`, `Community 131`, `generate_params`, `generate_params`, `Community 14`, `load_dna`, `_combined_interests`, `Community 24`, `calendar.py`, `geometric_lines.py`, `time_reading.py`, `Community 36`, `validate_interest.py`, `mastery_drill.py`, `generator.py`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `get_interest_themes`, `Community 78`, `_get_available_formats`, `Community 87`, `mass_capacity.py`, `Community 101`, `Community 102`, `Community 117`, `generate_params`, `Community 118`, `Community 123`?**
