...
## Corpus Check
- 470 files · ~771,437 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3554 nodes · 5602 edges · 294 communities (271 shown, 23 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `502f3d79`
...
Cohesion: 0.09
Nodes (32): _audit_node(), build_test_profiles(), _check_cap_vs_formatter_code(), check_checklist_compliance(), _check_variant_sensitivity(), _check_visual_capacity(), extract_numeric_state(), get_lab_config() (+24 more)
...
Cohesion: 0.11
Nodes (35): SessionLocal(), Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache(), Practice Generation — Difficulty Axes Catalog ==================================, Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache(), mark_intro_viewed(), Background task to pre-generate questions into the cache.     Uses parallel exec (+27 more)
...
Cohesion: 0.06
Nodes (50): get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, Any, Registry to map visual types to their Pydantic schemas., VisualSchemaRegistry, _parse_contract_section_refs(), Practice Generation — Validation Harness Runner  Runs all validators in the prac, Extract every '§1A'-style reference from docs/pgen_contract.md's rule     table (+42 more)
...
Cohesion: 0.15
Nodes (25): get_axes_for_concept(), Return the UI-ready axis list for a concept, or [] if not found., get_all_node_ids(), Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, _bound_allows(), build_group(), build_packet(), _main() (+17 more)
...
Cohesion: 0.06
Nodes (42): get_variants_for_dna(), is_variant_available_at(), Return all contextual variants defined for a DNA concept.      Args:         dna, Check if a variant is available at a specific grade/quarter per curriculum., DNA, Specification of a mathematical concept for practice generation.      dna_type:, Return param_bounds for grade, falling back to nearest defined grade., Return the index of a level within an axis (0 = easiest). (+34 more)
...
Cohesion: 0.15
Nodes (15): DimensionSpec, Compute the dimension value at difficulty scalar t.          If override_min/ove, Specification for a single difficulty dimension.      Defines how a dimension sc, generate_hints(), generate_params(), max_regrouping_places(), Any, DNA: Subtraction (Number & Algebra)  Refactored from:   - matatag_skeletons.py (+7 more)
...
Cohesion: 0.04
Nodes (53): ErrorPattern, A pedagogically meaningful wrong answer.      formula:          SymPy expression, A mathematical term fragment gated behind vocab knowledge.      preferred:    Te, VocabGated, generate_hints(), generate_params(), Any, DNA: Probability Experiment (Data & Probability)  Covers MATATAG grade 3 compete (+45 more)
...
Cohesion: 0.17
Nodes (12): _boundary_distance(), generate_hints(), generate_params(), Any, Return 2–4 step-by-step hints for a rounding problem., Round n to the nearest precision (10, 100, 1000) using round-half-up., Return how far n is from the nearest rounding boundary., Generate a rounding problem (G3 only).      Returns:         {             "numb (+4 more)
...
Cohesion: 0.10
Nodes (26): generate_hints(), generate_params(), Any, DNA: Addition (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (ar, Check if a pair satisfies regrouping difficulty based on COUNT of places.      C, True if `level` can be satisfied by some (a, b) with a + b <= max_result., Generate (a, b) that satisfy the difficulty_profile constraints.      Uses smart, # NOTE: "structure" is a contextual variant, not a difficulty dimension. (+18 more)

### Community 274 - "run"
Cohesion: 0.07
Nodes (32): get_dnas_for_formatter(), get_variant_curriculum_gate(), is_compatible(), Any, Practice Generation — DNA-Formatter Compatibility Table ========================, Validate a lab UI selection and return compatibility info.      Args:         dn, Return the curriculum introduction point for a variant, or None if no gate., Return True if the formatter is compatible with the given DNA concept.      Args (+24 more)
...
- **Why does `FormattedProblem` connect `Community 41` to `_get_available_formats`, `.axis_level_index`, `generate_params`, `Community 8`, `fmt_array_grid.py`, `generate_params`, `Community 13`, `fmt_ruler_measure.py`, `Community 18`, `Community 153`, `Community 25`, `Community 50`, `Community 51`, `Spine`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `models.py`, `Community 95`, `CompetencyConfiguration`, `2026-08-19 — Hardening Unit 1: restore two weakened tests (deliberate documented red)`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `_get_available_formats`, `.axis_level_index`, `generate_params`, `generate_params`, `Community 13`, `fmt_ruler_measure.py`, `Community 18`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `get_node_competency_bounds`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `models.py`, `Community 95`, `CompetencyConfiguration`, `Community 117`, `2026-08-19 — Hardening Unit 1: restore two weakened tests (deliberate documented red)`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `DNA` connect `Community 117` to `generate_params`, `Community 131`, `Community 11`, `Community 14`, `test_regrouping_feasibility.py`, `Community 24`, `geometric_lines.py`, `Community 36`, `Community 41`, `validate_interest.py`, `generator.py`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `_get_available_formats`, `Community 87`, `mass_capacity.py`, `Community 100`, `Community 101`, `Community 102`, `generate_params`, `Community 118`, `Community 123`?**
