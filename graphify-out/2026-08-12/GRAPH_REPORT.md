...
## Corpus Check
- 283 files · ~460,088 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3070 nodes · 5002 edges · 237 communities (221 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `567848a4`
...
Cohesion: 0.22
Nodes (7): Any, Generate a single practice problem and return it as a dict.      This is the sin, Generate a batch of varied practice problems and return them as dicts.      Args, run(), run_batch(), Mechanical triage for co-mapped-DNA bleed: for every FAIL/CONCERN node mapped to, test_unmapped_bound_accepts_an_absolute_magnitude()
...
Cohesion: 0.09
Nodes (27): get_formatters_for_dna(), is_variant_available_at(), Check if a variant is available at a specific grade/quarter per curriculum., Return all formatter names compatible with a given DNA concept.      Args:, get_node_dnas(), get_node_formatters(), Return the list of DNA concept names for a node.      Args:         node_id: MAT, Return the union of compatible formatters from all DNAs for a node.      Looks u (+19 more)
...
Cohesion: 0.08
Nodes (35): get_node_competency_bounds(), _parse_competency_bounds(), Parse competency text to extract bounds for difficulty dimensions.      Returns, Get competency-specific bounds for a node's difficulty dimensions.          Retu, _audit_node(), AuditHarnessError, build_test_profiles(), _check_cap_vs_formatter_code() (+27 more)
...
Cohesion: 0.06
Nodes (63): get_all_node_ids(), get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, _bound_allows(), build_group(), build_packet(), _main() (+55 more)

### Community 191 - "Native SQL Examples"
Cohesion: 0.14
Nodes (24): get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, count_addition_carries(), count_subtraction_borrows(), get_expected_mapped_value(), get_variant_combinations(), main(), _numeric_payload_values() (+16 more)
...
### Community 223 - "VisualSchemaRegistry"
Cohesion: 0.50
...
- **Why does `FormattedProblem` connect `Community 4` to `Community 8`, `Community 13`, `Community 14`, `Community 24`, `Community 153`, `Community 25`, `Community 41`, `Community 50`, `Community 51`, `Spine`, `SKILL.md`, `validate_interest.py`, `find_node_id`, `Community 59`, `Community 60`, `get_gemini_models`, `fmt_ordering.py`, `get_engine`, `Community 70`, `Community 77`, `Community 78`, `Community 79`, `time_reading.py`, `Community 90`, `Community 92`, `Phase 0 — Consolidate duplicated registries (prerequisite)`, `Community 93`, `Community 94`, `Community 95`, `Understanding the Continuous Scalar and `d=5``, `Community 99`, `Community 118`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 1`, `Community 4`, `Community 13`, `Community 14`, `Community 24`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `SKILL.md`, `Community 59`, `Community 60`, `get_gemini_models`, `fmt_ordering.py`, `Community 70`, `Community 77`, `Community 78`, `Community 79`, `geometric_lines.py`, `time_reading.py`, `Community 90`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 99`, `Community 118`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `get_available_intro_nodes()` connect `Part 1 — Diagnosis: how the current docs cause bugs` to `Community 8`, `Section 7: i18n chrome audit`?**
