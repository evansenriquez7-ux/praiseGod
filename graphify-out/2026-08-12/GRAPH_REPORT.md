# Graph Report - ccmed  (2026-08-11)

## Corpus Check
- 433 files · ~566,152 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3040 nodes · 4943 edges · 236 communities (220 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b6473c12`
...
## Communities (236 total, 16 thin omitted)
...
Cohesion: 0.07
Nodes (44): get_variants_for_dna(), Return all contextual variants defined for a DNA concept.      Args:         dna, _build_symbolic_question(), _detect_axes_served(), _eval_error_formula(), generate_context(), get_node(), Any (+36 more)
...
Cohesion: 0.14
Nodes (31): get_db(), FastAPI dependency that yields a database session.     Guarantees session closur, get_axes_for_concept(), Practice Generation — Difficulty Axes Catalog ==================================, Return the UI-ready axis list for a concept, or [] if not found., Practice Generation — Pipeline Coordinator =====================================, Generate a batch of varied practice problems and return them as dicts.      Args, run_batch() (+23 more)
...
Cohesion: 0.10
Nodes (26): log_interpolate(), Logarithmic interpolation between min_val and max_val at position t.      Produc, generate_hints(), generate_params(), Any, DNA: Length Measurement (Measurement & Geometry)  Covers MATATAG grades 1–2 leng, Returns numeric params used by the ruler_measure formatter or word-problem spine, _standard_unit_bounds() (+18 more)
...
Cohesion: 0.08
Nodes (36): SessionLocal(), Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache(), CompetencyConfiguration, Generate a single practice problem and return it as a dict.      This is the sin, run(), Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache() (+28 more)
...
Cohesion: 0.09
Nodes (36): get_all_node_ids(), get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, _bound_allows(), build_group(), build_packet(), _main() (+28 more)

### Community 191 - "Native SQL Examples"
Cohesion: 0.12
Nodes (25): Any, Registry to map visual types to their Pydantic schemas., VisualSchemaRegistry, count_addition_carries(), count_subtraction_borrows(), get_expected_mapped_value(), get_variant_combinations(), main() (+17 more)
...
### Community 231 - "get_node_capabilities"
Cohesion: 0.29
...
- **Why does `FormattedProblem` connect `Community 4` to `Community 8`, `Community 13`, `Community 14`, `Community 153`, `Community 41`, `Community 50`, `Community 51`, `Spine`, `SKILL.md`, `validate_interest.py`, `find_node_id`, `Community 59`, `Community 60`, `get_gemini_models`, `fmt_ordering.py`, `Community 70`, `Community 77`, `Community 78`, `Community 79`, `Community 90`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 99`, `Community 103`, `Community 118`?**
...
- **Why does `get_available_intro_nodes()` connect `Community 5` to `Community 8`?**
