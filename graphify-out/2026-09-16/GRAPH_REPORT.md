...
## Corpus Check
- 867 files · ~1,639,938 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5815 nodes · 9216 edges · 450 communities (404 shown, 46 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 124 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2152ffca`
...
3. `Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02` - 105 edges
...
- `TestCrashIsolationEndToEnd` --uses--> `StageResult`  [INFERRED]
  tests/unit/test_stage_ledger.py → backend/app/practice_gen/validation/run_all.py

## Import Cycles
- None detected.

## Communities (450 total, 46 thin omitted)
...
Cohesion: 0.11
Nodes (32): _attestation_staleness(), §6F freshness -- an attestation is evidence about *specific rendered content*, a, _answer_display(), _answer_value(), _node_file(), _normalize(), _option_values(), _packet_core_from_review() (+24 more)
...
Cohesion: 0.06
Nodes (56): definition_digest(), environment_fingerprint(), error_family(), evaluate(), input_digest(), input_manifest(), _iter_input_files(), load_proofs() (+48 more)
...
Cohesion: 0.05
Nodes (60): Any, Registry to map visual types to their Pydantic schemas., VisualSchemaRegistry, _eval_formula(), Evaluate a formula string with values as variable bindings., _answer_leaks_into_stem(), applicability_failures(), count_addition_carries() (+52 more)
...
Cohesion: 0.04
Nodes (53): 1. Distractor Non-Determinism Fix in `place_value.py`, 1. Fractions answer-key false positive — `mat_g2_na_q4_0`/`_1`/`_2`, 2026-08-13 — Content no competency asks for, and a metre wearing centimetres, 2026-08-13 — The G1 measure items: a visual for the task, and a size model for the units, 2026-08-13 — The unanswerable measure item was a routing bug, not a wording one, 2026-08-19 — Unit 3 completion + full `run_all` verification, 2026-08-20 (tick 6) — There is no pytest deadlock, and three tests I broke in tick 3, 2026-08-23 — §6G: an attestation must show its work (+45 more)
...
Cohesion: 0.09
Nodes (27): get_dnas_for_formatter(), Return all DNA concept names that support a given formatter.      Performs a rev, get_node_formatters(), Return the union of compatible formatters from all DNAs for a node.      Looks u, build_budget(), derive_count_independently(), _derived_coverage(), enumerate_obligations() (+19 more)
...
Cohesion: 0.07
Nodes (44): node_grade_quarter(), The (grade, quarter) a node sits at, parsed from its id.      One copy, because, get_all_node_ids(), get_node_competency_bounds(), Get competency-specific bounds for a node's difficulty dimensions.          Retu, Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, Practice Generation — Compatibility & Registry Coverage Validation  Verifies tha, §2I — a discrete variant a node DECLARES must be one the node can actually produ (+36 more)
...
Cohesion: 0.10
Nodes (21): get_interest_themes(), Return all interest themes. Grade parameter is ignored (kept for API compatibili, _combined_interests(), get_intro_content(), get_intro_status(), get_matatag_progress(), get_node_config(), list_intro_interests() (+13 more)
...
Cohesion: 0.13
Nodes (20): CompletedProcess, _fresh(), The validation package pins DATABASE_URL before anything can capture it, and say, The form EVERY mutation command uses, and the gap that made the first version of, The runner itself, for the same reason., The consequence that matters: `get_engine()` refuses instead of dialling out., A deliberately set DATABASE_URL must NOT win. That is the point: the harness's v, Protocol 3: no silent defaults. Overriding a variable the operator set must say (+12 more)
...
Cohesion: 0.17
Nodes (24): _benchmark_findings(), collect_findings(), main(), §11 — the student-path obligation manifest and executor hold themselves to produ, Run one independent §11 direction for clean mutation controls., _run_single(), _sentinel_findings(), validate_all() (+16 more)
...
Cohesion: 0.14
Nodes (21): CompetencyConfiguration, LabV2ConfigSaveRequest, LabV2GenerateRequest, LabV2SubmitRequest, Request body for /api/matatag/lab/v2/generate, Request body for /api/matatag/lab/v2/submit, Save the enabled checkboxes for a node, with curriculum validation., save_node_config() (+13 more)
...
Cohesion: 0.07
Nodes (56): apply_experience(), apply_formatter(), generate_batch(), generate_problem(), _get_dna_instance(), Any, Random, Practice Generation — API Adapter ===================================  Main entr (+48 more)
...
Cohesion: 0.40
Nodes (5): generate_hints(), generate_params(), Any, DNA: Calendar (Measurement & Geometry)  Covers MATATAG grades 1–2 calendar compe, Returns visual_params for the Calendar formatter and an answer value.       {"mo
...
Cohesion: 0.11
Nodes (20): A mathematical term fragment gated behind vocab knowledge.      preferred:    Te, VocabGated, generate_hints(), generate_params(), Any, DNA: Symmetry and Slides (Measurement & Geometry)  Covers MATATAG grades 2–3 sym, Sample one item from the static pool filtered by grade, concept, and directions., get_node() (+12 more)
...
### Community 361 - "Any"
Cohesion: 0.09
Nodes (27): decompose_to_places(), "N is H hundreds, T tens, and O ones." (place values whose digit is 0     are om, generate_hints(), generate_params(), Any, DNA: Subtraction (Number & Algebra)  Refactored from:   - matatag_skeletons.py, Check if a pair satisfies borrowing difficulty based on COUNT of places.      Fo, Generate (a, b) with a >= b that satisfy the difficulty_profile constraints. (+19 more)
...
Cohesion: 0.32
Nodes (7): NumberBondInteractive(), QuestionRenderer(), SortOrderInteractive(), renderMath(), renderVisualInner(), ParentDashboard(), PracticeView()
...
### Community 376 - "Spine"
Cohesion: 0.27
Nodes (6): API_BASE, App(), FlagModal(), TelemetryModal(), useSoundEffects(), LoginView()
...
Cohesion: 0.18
Nodes (8): DimensionSpec, Any, Compute the dimension value at difficulty scalar t.          If override_min/ove, Fill template with interest slots and numeric values.                  Handles s, The singular of a count-noun phrase. Returns `phrase` unchanged when already sin, Serialize to dict for API response., Specification for a single difficulty dimension.      Defines how a dimension sc, to_singular_phrase()
...
Cohesion: 0.09
Nodes (43): max_regrouping_places(), Largest borrow count achievable for any (a, b) with a <= max_minuend, a >= b., get_pipeline_status(), Return a health-check dict for the pipeline.      Checks:       - Whether each o, _bound_allows(), build_group(), build_packet(), _continuous_axis_names() (+35 more)
...
Cohesion: 0.22
Nodes (5): get_variant_curriculum_gate(), is_compatible(), Practice Generation — DNA-Formatter Compatibility Table ========================, Return the curriculum introduction point for a variant, or None if no gate., Return True if the formatter is compatible with the given DNA concept.      Args

### Community 407 - "2026-08-23 — tick 24 — 90 clauses attested; the medium clauses are where the tree is thinnest"
Cohesion: 0.08
Nodes (33): Any, Practice Generation — Pipeline Coordinator =====================================, Generate a single practice problem and return it as a dict.      This is the sin, Generate a batch of varied practice problems and return them as dicts.      Args, run(), run_batch(), find_node_id(), _parse_competency_bounds() (+25 more)
...
### Community 412 - "socratic_chat_exchange"
Cohesion: 0.32
...
Cohesion: 0.14
Nodes (12): log_scale_value(), The integer a 0-1 position `t` maps to on a logarithmic axis [min_val, max_val]., get_matatag_difficulty_axes(), get_matatag_lab_config(), get_matatag_lab_interests(), get_matatag_nodes(), _get_max_regrouping_places(), Max regrouping/borrowing places feasible for a given number range.      Thin wra (+4 more)
...
### Community 426 - "get_node_capabilities"
Cohesion: 0.40
...
### Community 428 - "test_shared_bounds_is_detected_by_sharedness_not_length"
Cohesion: 0.40
...
### Community 432 - "2026-08-13 — length_measurement: the largest FAIL cluster in the tree"
Cohesion: 0.50
...
### Community 433 - "answerRoundtrip.test.jsx"
Cohesion: 0.33
...
### Community 436 - "socratic_chat_exchange"
Cohesion: 0.40
...
### Community 439 - "2026-08-14 — "2-digit by 1-digit" bounds two operands, and only one had a key"
Cohesion: 0.50
...
### Community 440 - "2026-08-20 — §5 worker death: a silent unbounded wait in the last gate"
Cohesion: 0.50
...
### Community 441 - "2026-08-20 (tick 7) — The harness now runs its own tests"
Cohesion: 0.50
Nodes (4): 2026-08-20 (tick 7) — The harness now runs its own tests, Proved, not assumed, What shipped, Why

## Knowledge Gaps
- **2059 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+2054 more)
...
- **Why does `FormattedProblem` connect `test_bounds_length_is_never_the_discriminator` to `Queries`, `2026-08-14 — "2-digit by 1-digit" bounds two operands, and only one had a key`, `fmt_array_grid.py`, `_get_available_formats`, `test_contradicted_entry_is_caught_by_name`, `Community 13`, `test_omission_survives_provenance_but_not_coverage`, `run_all.py`, `2026-08-14 — The blank landed on a given, not on the unknown`, `Community 50`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `fractions.py`, `get_gemini_models`, `Community 70`, `Community 75`, `Community 79`, `Community 94`, `Tick 23 — 2026-08-22 — the contradiction closes, and the Attester's aside was the next bug`, `_numeric_payload_values`, `test_contradicted_entry_is_caught_by_name`, `Any`, `_profile_echo_keys`, `2026-08-13 — Content no competency asks for, and a metre wearing centimetres`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `_render_sample()` connect `.axis_level_index` to `Community 99`, `2026-08-13 — length_measurement: the largest FAIL cluster in the tree`, `Community 11`, `test_attested_capability_is_not_reported_unattested`, `test_semantic_leak_guards.py`, `Community 93`, `2026-08-23 — tick 24 — 90 clauses attested; the medium clauses are where the tree is thinnest`, `2026-08-14 — "2-digit by 1-digit" bounds two operands, and only one had a key`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `get_all_node_ids()` connect `test_semantic_leak_guards.py` to `2026-08-14 — "2-digit by 1-digit" bounds two operands, and only one had a key`, `Community 4`, `.axis_level_index`, `Community 11`, `Community 16`, `test_attestation_without_samples_cannot_be_checked_and_fails`, `2026-08-23 — tick 24 — 90 clauses attested; the medium clauses are where the tree is thinnest`, `Mutations`, `Community 26`, `Community 41`, `Part 1 — Extending the pipeline`, `generator.py`, `validate_capability.py`, `2026-08-13 — perimeter: an impossible triangle, and two shapes that never appeared`, `hardening_supervisor.py`, `Community 93`, `fmt_numeric_input.py`, `Community 99`, `Community 125`, `2026-08-13 — Content no competency asks for, and a metre wearing centimetres`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
