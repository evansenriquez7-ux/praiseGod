...
## Summary
- 3633 nodes · 5703 edges · 301 communities (284 shown, 17 thin omitted)
...
Cohesion: 0.13
Nodes (23): _audit_node(), AuditHarnessError, build_test_profiles(), _check_cap_vs_formatter_code(), _check_variant_sensitivity(), _check_visual_capacity(), extract_numeric_state(), get_lab_config() (+15 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (61): _gen_g2_dp_q3_pictograph(), _gen_g2_mg_q1_circles(), _gen_g2_mg_q1_slides(), _gen_g2_mg_q2_measurement(), _gen_g2_mg_q4_perimeter(), _gen_g2_mg_q4_solid_figures(), _gen_g2_mg_q4_time(), _gen_g2_na_q1_addition() (+53 more)
...
Cohesion: 0.07
Nodes (14): RedisDict, RedisDict, get_matatag_competencies(), Return MATATAG competencies for dropdown selection in Problem Lab.          Resp, RedisDict, RedisDict, _match_competency_to_visual_type(), Any (+6 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (71): is_variant_available_at(), Check if a variant is available at a specific grade/quarter per curriculum., get_node(), Return the raw knowledge-graph node dict for node_id, or None.      Args:, get_all_node_ids(), get_node_info(), Return the full knowledge-graph node dict for a node.      Args:         node_id, Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return (+63 more)
...
Cohesion: 0.08
Nodes (33): interpolate(), linear_interpolate(), log_interpolate(), Logarithmic interpolation between min_val and max_val at position t.      Produc, Linear interpolation between min_val and max_val at position t., Interpolate between min_val and max_val using the given scale type.      scale_t, generate_hints(), generate_params() (+25 more)
...
Cohesion: 0.13
Nodes (25): apply_experience(), apply_formatter(), generate_batch(), generate_problem(), _get_dna_instance(), Any, Random, Practice Generation — API Adapter ===================================  Main entr (+17 more)
...
Cohesion: 0.11
Nodes (24): decompose_to_places(), generate_hints(), generate_params(), max_regrouping_places(), Any, DNA: Addition (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (ar, "N is H hundreds, T tens, and O ones." (place values whose digit is 0     are om, Largest carry count physically achievable for any (a, b) with a + b <= max_resul (+16 more)
...
Cohesion: 0.33
Nodes (6): _combined_interests(), Session, Socratic Tutor split-screen dialog endpoint.     Guides the student out of their, Merge parent-set interest_tags and student-set student_interest_tags into a, socratic_chat_exchange(), SocraticChatRequest
...
Cohesion: 0.29
Nodes (7): _import_dna_module(), Dynamically import the DNA module for a given concept name.      Looks up the co, get_pipeline_status(), Any, Return a health-check dict for the pipeline.      Checks:       - Whether each o, get_node_capabilities(), Introspect DNA to return available axes, variants, and formatters.

## Knowledge Gaps
- **1188 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+1183 more)
