...
## Corpus Check
- 448 files · ~644,793 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3207 nodes · 5177 edges · 249 communities (233 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `89e2188f`
...
Cohesion: 0.15
Nodes (19): _node_file(), _normalize(), _provenance_corpus(), Any, Path, Practice Generation — Judgment Review Validator (hard gate)  The judgment items, Return a list of schema/quality errors for one node's review file., Collapse whitespace so re-rendered text compares on content, not layout. (+11 more)
...
Cohesion: 0.14
Nodes (22): _build_traps(), _build_visual_params(), format_array_grid(), Random, fmt_array_grid.py — ArrayGrid (GridArea) visual formatter  Produces a FormattedP, Write `terms` copies of `addend` as a repeated sum, or describe it when     writ, Build an ArrayGrid FormattedProblem from a QuestionContext.      interaction_mod, Build ArrayGrid visual_params.      Grade 2: arrays up to 10×10 (multiplication (+14 more)
...
Cohesion: 0.18
Nodes (14): decompose_to_places(), "N is H hundreds, T tens, and O ones." (place values whose digit is 0     are om, generate_hints(), generate_params(), max_regrouping_places(), Any, DNA: Subtraction (Number & Algebra)  Refactored from:   - matatag_skeletons.py, Largest borrow count achievable for any (a, b) with a <= max_minuend, a >= b. (+6 more)
...
Cohesion: 0.09
Nodes (32): get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, get_matatag_lab_config(), _get_max_regrouping_places(), Max regrouping/borrowing places feasible for a given number range.      Thin wra, Return full lab configuration for a MATATAG node.      Includes:     - difficult, _audit_node(), AuditHarnessError (+24 more)
...
Cohesion: 0.14
Nodes (21): Any, Registry to map visual types to their Pydantic schemas., VisualSchemaRegistry, _eval_formula(), Evaluate a formula string with values as variable bindings., count_addition_carries(), count_subtraction_borrows(), get_expected_mapped_value() (+13 more)
...
Cohesion: 0.10
Nodes (27): interpolate(), linear_interpolate(), log_interpolate(), Compute the dimension value at difficulty scalar t.          If override_min/ove, Logarithmic interpolation between min_val and max_val at position t.      Produc, Linear interpolation between min_val and max_val at position t., Interpolate between min_val and max_val using the given scale type.      scale_t, generate_hints() (+19 more)
...
## Knowledge Gaps
- **952 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+947 more)
...
- **Why does `FormattedProblem` connect `test_semantic_leak_guards.py` to `Community 4`, `Community 8`, `Community 13`, `Community 16`, `Community 24`, `Community 153`, `Community 41`, `Community 50`, `Community 51`, `Spine`, `SKILL.md`, `validate_interest.py`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `fmt_bar_chart.py`, `Community 99`, `fmt_numeric_input.py`, `Community 117`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 1`, `Community 4`, `Community 13`, `Community 16`, `Community 24`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `SKILL.md`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `get_engine`, `Community 77`, `Community 79`, `Community 92`, `Community 93`, `Community 94`, `test_semantic_leak_guards.py`, `Community 95`, `fmt_bar_chart.py`, `fmt_numeric_input.py`, `Community 117`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `DNA` connect `Community 104` to `Community 1`, `Community 3`, `Community 131`, `Community 11`, `Community 14`, `SKILL.md`, `Community 24`, `Community 26`, `mastery_drill.py`, `Native SQL Examples`, `Native SQL Examples`, `counting.py`, `get_engine`, `Community 75`, `Community 86`, `Community 87`, `Part 1 — Diagnosis: how the current docs cause bugs`, `test_semantic_leak_guards.py`, `Community 100`, `Community 101`, `Community 118`?**
