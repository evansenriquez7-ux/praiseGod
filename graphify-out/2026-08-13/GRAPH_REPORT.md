...
## Corpus Check
- 448 files · ~655,299 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3264 nodes · 5242 edges · 263 communities (247 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0af9257c`
...
## Communities (263 total, 16 thin omitted)
...
Cohesion: 0.14
Nodes (19): Generate a single practice problem and return it as a dict.      This is the sin, run(), Exception, _all_node_ids(), _audit_node_grader(), _emit_correct(), main(), Any (+11 more)
...
Cohesion: 0.10
Nodes (24): CompetencyConfiguration, get_intro_status(), get_matatag_progress(), get_node_config(), LabV2ConfigSaveRequest, LabV2GenerateRequest, LabV2SubmitRequest, mark_intro_viewed() (+16 more)
...
Cohesion: 0.14
Nodes (9): get_supported_variants(), Return variants supported by a specific DNA + formatter combination.      Applie, _continuous_axes_with_default_range(), Tests for the axes-catalog logarithmic scale and the auditor's ``build_test_prof, ``build_test_profiles`` must include every config-declared     contextual-varian, Yield (concept, axis) for every continuous axis that has both     default_min an, Every continuous axis whose range spans >= 10x must declare     ``scale: 'logari, TestBuildTestProfilesVariantCoverage (+1 more)
...
Cohesion: 0.17
Nodes (14): _distractor_fallback.py — Distractor Augmentation Helper  Per AGENTS.md rule #4:, _build_equation_sentence(), format_cloze(), Random, Textual Formatter — Cloze (Fill-in-the-Blank)  Unified formatter for fill-in-the, Format a QuestionContext as a cloze (fill-in-the-blank) problem.      Respects t, Build pure equation with blank based on concept and blank_target., _build_traps() (+6 more)
...
## Knowledge Gaps
- **992 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+987 more)
...
- **Why does `FormattedProblem` connect `Community 4` to `Community 8`, `build_scaffold_sequence`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 24`, `Community 153`, `Community 41`, `Community 50`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `CompetencyConfiguration`, `test_semantic_leak_guards.py`, `time_reading.py`, `Community 92`, `calendar.py`, `Community 93`, `fmt_bar_chart.py`, `Community 95`, `CompetencyConfiguration`, `Community 104`, `fmt_ruler_measure.py`, `RedisDict`, `grader_roundtrip_auditor.py`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `Community 1`, `Community 4`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 24`, `Community 153`, `Community 41`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `generator.py`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_get_available_formats`, `time_reading.py`, `Community 92`, `Community 93`, `calendar.py`, `fmt_bar_chart.py`, `Community 95`, `CompetencyConfiguration`, `fmt_ruler_measure.py`, `grader_roundtrip_auditor.py`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `DNA` connect `Community 24` to `Community 1`, `.axis_level_index`, `Community 131`, `build_scaffold_sequence`, `Community 14`, `Community 18`, `Community 26`, `generator.py`, `_are_values_equal`, `counting.py`, `Community 75`, `get_interest_themes`, `Community 86`, `Part 1 — Diagnosis: how the current docs cause bugs`, `Community 94`, `frontend_contract_auditor.py`, `Community 100`, `Community 101`, `counting.py`, `Community 118`?**
