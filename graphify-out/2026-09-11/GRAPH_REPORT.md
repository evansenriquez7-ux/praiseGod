...
## Corpus Check
- 661 files · ~1,273,139 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4864 nodes · 7396 edges · 385 communities (343 shown, 42 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 103 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8cb8dd22`
...
3. `Phase F — full `run_all` verification and three more regressions it caught — 2026-08-02` - 88 edges
...
Cohesion: 0.15
Nodes (27): get_db(), FastAPI dependency that yields a database session.     Guarantees session closur, SessionLocal(), Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache(), Background task to pre-generate questions into the cache.     Uses parallel exec, replenish_question_cache(), Background task to pre-generate questions into the cache.     Uses parallel exec (+19 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (83): get_axes_for_concept(), Return the UI-ready axis list for a concept, or [] if not found., get_dnas_for_formatter(), get_variant_curriculum_gate(), get_variants_for_dna(), is_compatible(), is_variant_available_at(), node_grade_quarter() (+75 more)
...
Cohesion: 0.06
Nodes (53): get_all_node_ids(), get_node_dnas(), get_node_formatters(), Return the list of DNA concept names for a node.      Args:         node_id: MAT, Return the union of compatible formatters from all DNAs for a node.      Looks u, Return all node IDs from NODE_TO_DNA, optionally filtered.      Nodes are return, Practice Generation — Compatibility & Registry Coverage Validation  Verifies tha, Run all compatibility and coverage checks and print a summary.      Returns: (+45 more)
...
Cohesion: 0.17
Nodes (18): _answer_display(), _answer_value(), _normalize(), _option_values(), _provenance_corpus(), Any, Practice Generation — Judgment Review Validator (hard gate)  The judgment items, Collapse whitespace so re-rendered text compares on content, not layout. (+10 more)
...
Cohesion: 0.05
Nodes (42): 1. Distractor Non-Determinism Fix in `place_value.py`, 1. Fractions answer-key false positive — `mat_g2_na_q4_0`/`_1`/`_2`, 2026-08-13 — length_measurement: the largest FAIL cluster in the tree, 2026-08-13 — "less than N" was parsed as "up to N", 2026-08-14 — "2-digit by 1-digit" bounds two operands, and only one had a key, 2026-08-19 — Unit 3 completion + full `run_all` verification, 2026-08-20 — §5 worker death: a silent unbounded wait in the last gate, 2026-08-23 — §6G: an attestation must show its work (+34 more)

### Community 104 - "Community 104"
Cohesion: 0.04
Nodes (56): ErrorPattern, A pedagogically meaningful wrong answer.      formula:          SymPy expression, A mathematical term fragment gated behind vocab knowledge.      preferred:    Te, VocabGated, generate_hints(), generate_params(), Any, DNA: Probability Experiment (Data & Probability)  Covers MATATAG grade 3 compete (+48 more)
...
Cohesion: 0.12
Nodes (25): Collapse a rationale to the structure that survives per-node substitution., Every span a rationale puts in quotes must exist in the review's own packet., One reviewer identity may not stamp the whole tree.      Blind review is dispatc, _rationale_skeleton(), _validate_quote_provenance(), _validate_reviewer_plurality(), test_judgment_antitemplate.py ============================= The judgment gate's, Same frame, different node/seeds/quotes -> identical skeleton. This is the tell. (+17 more)
...
Cohesion: 0.14
Nodes (14): _boundary_distance(), generate_hints(), generate_params(), Any, Return 2–4 step-by-step hints for a rounding problem., Round n to the nearest precision (10, 100, 1000) using round-half-up., Return how far n is from the nearest rounding boundary., Generate a rounding problem (G3 only).      Returns:         {             "numb (+6 more)
...
Cohesion: 0.16
Nodes (17): generate_hints(), generate_params(), max_regrouping_places(), Any, DNA: Addition (Number & Algebra)  Refactored from:   - matatag_skeletons.py  (ar, Return 2–4 step-by-step hint strings for the given addition problem., Check if a pair satisfies regrouping difficulty based on COUNT of places.      C, Largest carry count physically achievable for any (a, b) with a + b <= max_resul (+9 more)
...
Cohesion: 0.11
Nodes (28): max_regrouping_places(), Largest borrow count achievable for any (a, b) with a <= max_minuend, a >= b., _bound_allows(), build_group(), build_packet(), _main(), _max_regrouping_places_for(), Any (+20 more)
...
Cohesion: 0.22
Nodes (6): DimensionSpec, Any, Compute the dimension value at difficulty scalar t.          If override_min/ove, Fill template with interest slots and numeric values.                  Handles s, Serialize to dict for API response., Specification for a single difficulty dimension.      Defines how a dimension sc
...
## Knowledge Gaps
- **1907 isolated node(s):** `graphify`, `PackageDescription`, `Foundation`, `PathKit`, `graphify-mcp` (+1902 more)
...
- **Why does `FormattedProblem` connect `test_omission_survives_provenance_but_not_coverage` to `fmt_numeric_input.py`, `fmt_array_grid.py`, `Community 138`, `Community 13`, `Community 18`, `Mutations`, `2026-08-13 — The G1 measure items: a visual for the task, and a size model for the units`, `Community 26`, `test_planted_mutation_bounds_only_provider_is_caught_by_name`, `Community 50`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `fractions.py`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `_combined_interests`, `Community 92`, `Community 95`, `socratic_chat_exchange`, `2026-08-13 — length_measurement: the largest FAIL cluster in the tree`, `mastery_drill.py`, `fmt_ruler_measure.py`, `2026-08-13 — Content no competency asks for, and a metre wearing centimetres`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `get_node_info()` connect `Community 9` to `Community 4`, `Community 104`, `Community 41`, `Community 75`, `Community 16`, `test_attestation_without_samples_cannot_be_checked_and_fails`, `test_omission_survives_provenance_but_not_coverage`, `Community 117`, `Community 86`, `hardening_supervisor.py`, `Community 26`, `Community 94`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `QuestionContext` connect `Community 50` to `fmt_numeric_input.py`, `fmt_array_grid.py`, `Community 138`, `Community 9`, `Community 13`, `Community 18`, `test_omission_survives_provenance_but_not_coverage`, `2026-08-13 — The G1 measure items: a visual for the task, and a size model for the units`, `test_planted_mutation_bounds_only_provider_is_caught_by_name`, `Community 51`, `Spine`, `Community 59`, `Community 60`, `fractions.py`, `get_gemini_models`, `Community 70`, `Community 77`, `Community 79`, `Community 92`, `Community 95`, `socratic_chat_exchange`, `2026-08-13 — length_measurement: the largest FAIL cluster in the tree`, `Community 104`, `mastery_drill.py`, `2026-08-13 — Content no competency asks for, and a metre wearing centimetres`?**
